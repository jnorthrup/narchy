...
//        loop(window);
//
//        gl.shutdown(window.getGL().getGL3());
...
//
//
//    private void loop(GLWindow window) {
//
...
//            two flags.  */
//        //gl.newFrame(window.getGL().getGL3());
//        //gl.setWindow(window);
//
//
//
...
//
//        // Rendering
//        gln.GlnKt.glViewport(window.getSurfaceWidth(), window.getSurfaceHeight());
//        gln.GlnKt.glClearColor(clearColor);
//        gl.getGl().glClear(GL_COLOR_BUFFER_BIT);
//
//        imgui.render();

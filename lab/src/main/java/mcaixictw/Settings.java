...
public abstract class Settings implements Cloneable {
	 ...
	 * @return
	 */
	protected static boolean parseBoolean(String parameter, boolean def, File file) {
	 ...
	 * @return
	 */
	protected static int parseInt(String parameter, int def, File file) {
		try (Scanner scanner = new Scanner(file)) {
			String s = scanner.findWithinHorizon(parameter
	 ...
	 * @return
	 */
	protected static double parseDouble(String parameter, double def, File file) {
		try (Scanner scanner = new Scanner(file)) {
			String s = scanner.findWithinHorizon(parameter

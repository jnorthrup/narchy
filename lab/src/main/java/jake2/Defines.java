...
public class Defines {
	...
	public final static int PM_GIB = 3; 
	...
	public final static int MAX_STRING_CHARS = 1024; 
	public final static int MAX_STRING_TOKENS = 80; 
	public final static int MAX_TOKEN_CHARS = 1024; 

	public final static int MAX_QPATH = 64; 
	public final static int MAX_OSPATH = 128; 

	
	public final static int MAX_CLIENTS = 256; 
	public final static int MAX_EDICTS = 1024; 
	public final static int MAX_LIGHTSTYLES = 256;
	public final static int MAX_MODELS = 256; 
	public final static int MAX_SOUNDS = 256; 
	public final static int MAX_IMAGES = 256;
	public final static int MAX_ITEMS = 256;
	public final static int MAX_GENERAL = (MAX_CLIENTS * 2); 

	
	public final static int PRINT_LOW = 0; 
	public final static int PRINT_MEDIUM = 1; 
	public final static int PRINT_HIGH = 2; 
	public final static int PRINT_CHAT = 3; 

	public final static int ERR_FATAL = 0; 
	public final static int ERR_DROP = 1; 
	public final static int ERR_DISCONNECT = 2; 

	public final static int PRINT_ALL = 0;
	public final static int PRINT_DEVELOPER = 1; 
	...
	public final static int CONTENTS_SOLID = 1; 
	public final static int CONTENTS_WINDOW = 2; 
	...
	public final static int CONTENTS_ORIGIN = 0x1000000; 

	public final static int CONTENTS_MONSTER = 0x2000000; 
	public final static int CONTENTS_DEADMONSTER = 0x4000000;
	public final static int CONTENTS_DETAIL = 0x8000000; 
	public final static int CONTENTS_TRANSLUCENT = 0x10000000; 
	public final static int CONTENTS_LADDER = 0x20000000;

	public final static int SURF_LIGHT = 0x1; 
	public final static int SURF_SLICK = 0x2; 

	public final static int SURF_SKY = 0x4; 
	public final static int SURF_WARP = 0x8; 
	public final static int SURF_TRANS33 = 0x10;
	public final static int SURF_TRANS66 = 0x20;
	public final static int SURF_FLOWING = 0x40; 
	public final static int SURF_NODRAW = 0x80; 
	...
	public final static int BUTTON_ANY = 128; 
	...
	public final static int EF_ROTATE = 0x00000001; 
	public final static int EF_GIB = 0x00000002; 
	public final static int EF_BLASTER = 0x00000008; 
	public final static int EF_ROCKET = 0x00000010; 
	...
	public final static int EF_ANIM01 = 0x00000400; 
	public final static int EF_ANIM23 = 0x00000800; 
	public final static int EF_ANIM_ALL = 0x00001000; 
	public final static int EF_ANIM_ALLFAST = 0x00002000; 
	...
	public final static int RF_MINLIGHT = 1; 
	public final static int RF_VIEWERMODEL = 2; 
	public final static int RF_WEAPONMODEL = 4; 
	public final static int RF_FULLBRIGHT = 8; 
	public final static int RF_DEPTHHACK = 16; 
	public final static int RF_TRANSLUCENT = 32;
	public final static int RF_FRAMELERP = 64;
	public final static int RF_BEAM = 128;
	public final static int RF_CUSTOMSKIN = 256; 
	public final static int RF_GLOW = 512; 
	...
	public final static int RF_IR_VISIBLE = 0x00008000; 
	public final static int RF_SHELL_DOUBLE = 0x00010000; 
	public final static int RF_SHELL_HALF_DAM = 0x00020000;
	public final static int RF_USE_DISGUISE = 0x00040000;
	

	
	public final static int RDF_UNDERWATER = 1; 
	public final static int RDF_NOWORLDMODEL = 2; 
	...
	public final static int MZ_SILENCED = 128; 
	...
	public final static int MZ2_WIDOW_PLASMABEAM = 151; 
	...
	public final static int CHAN_RELIABLE = 16; 

	
	public final static int ATTN_NONE = 0; 
	public final static int ATTN_NORM = 1;
	public final static int ATTN_IDLE = 2;
	public final static int ATTN_STATIC = 3; 
	...
	public final static int STAT_FLASHES = 15; 
	...
	public final static int DF_NO_HEALTH = 0x00000001; 
	public final static int DF_NO_ITEMS = 0x00000002; 
	public final static int DF_WEAPONS_STAY = 0x00000004; 
	public final static int DF_NO_FALLING = 0x00000008; 
	public final static int DF_INSTANT_ITEMS = 0x00000010; 
	public final static int DF_SAME_LEVEL = 0x00000020; 
	public final static int DF_SKINTEAMS = 0x00000040; 
	public final static int DF_MODELTEAMS = 0x00000080; 
	public final static int DF_NO_FRIENDLY_FIRE = 0x00000100; 
	public final static int DF_SPAWN_FARTHEST = 0x00000200; 
	public final static int DF_FORCE_RESPAWN = 0x00000400; 
	public final static int DF_NO_ARMOR = 0x00000800; 
	public final static int DF_ALLOW_EXIT = 0x00001000; 
	public final static int DF_INFINITE_AMMO = 0x00002000; 
	public final static int DF_QUAD_DROP = 0x00004000; 
	public final static int DF_FIXED_FOV = 0x00008000; 

	
	public final static int DF_QUADFIRE_DROP = 0x00010000; 
	...
	public final static int CS_SKYAXIS = 3; 
	public final static int CS_SKYROTATE = 4;
	public final static int CS_STATUSBAR = 5; 

	public final static int CS_AIRACCEL = 29; 
	public final static int CS_MAXCLIENTS = 30;
	public final static int CS_MAPCHECKSUM = 31; 
	...
	public final static int TE_BOSSTPORT = 22; 
	...
	public final static int F_LSTRING = 2; 
	public final static int F_GSTRING = 3; 
	public final static int F_VECTOR = 4;
	public final static int F_ANGLEHACK = 5;
	public final static int F_EDICT = 6; 
	public final static int F_ITEM = 7; 
	public final static int F_CLIENT = 8; 
	...
	public final static int ANIM_BASIC = 0; 
	...
	public final static int DAMAGE_RADIUS = 0x00000001; 
	public final static int DAMAGE_NO_ARMOR = 0x00000002; 
	public final static int DAMAGE_ENERGY = 0x00000004; 
	public final static int DAMAGE_NO_KNOCKBACK = 0x00000008; 
	public final static int DAMAGE_BULLET = 0x00000010; 
	public final static int DAMAGE_NO_PROTECTION = 0x00000020;
	

	public final static int DAMAGE_NO = 0;
	public final static int DAMAGE_YES = 1; 
	public final static int DAMAGE_AIM = 2; 
	...
	public final static int FL_SWIM = 0x00000002; 
	...
	public final static int FL_PARTIALGROUND = 0x00000100; 
	public final static int FL_WATERJUMP = 0x00000200; 
	public final static int FL_TEAMSLAVE = 0x00000400; 
	public final static int FL_NO_KNOCKBACK = 0x00000800;
	public final static int FL_POWER_ARMOR = 0x00001000; 
	public final static int FL_RESPAWN = 0x80000000; 

	public final static float FRAMETIME = 0.1f;

	
	public final static int TAG_GAME = 765; 
	public final static int TAG_LEVEL = 766; 
	...
	public final static int IT_WEAPON = 1; 
	...
	public final static int MOVETYPE_NONE = 0; 
	public final static int MOVETYPE_NOCLIP = 1; 
	public final static int MOVETYPE_PUSH = 2; 
	public final static int MOVETYPE_STOP = 3; 

	public final static int MOVETYPE_WALK = 4; 
	public final static int MOVETYPE_STEP = 5; 
	public final static int MOVETYPE_FLY = 6;
	public final static int MOVETYPE_TOSS = 7; 
	public final static int MOVETYPE_FLYMISSILE = 8; 
	...
	public final static int SOLID_NOT = 0; 
	public final static int SOLID_TRIGGER = 1; 
	public final static int SOLID_BBOX = 2; 
	public final static int SOLID_BSP = 3; 

	public final static int GAME_API_VERSION = 3;

	
	public final static int SVF_NOCLIENT = 0x00000001; 
	public final static int SVF_DEADMONSTER = 0x00000002; 
	public final static int SVF_MONSTER = 0x00000004; 
	...
	public final static int svc_sound = 9; 
	public final static int svc_print = 10; 
	public final static int svc_stufftext = 11;
	
	public final static int svc_serverdata = 12; 
	public final static int svc_configstring = 13; 
	public final static int svc_spawnbaseline = 14;
	public final static int svc_centerprint = 15; 
	public final static int svc_download = 16; 
	public final static int svc_playerinfo = 17; 
	...
	public final static int UPDATE_BACKUP = 16; 
	...
	public final static int U_FRAME8 = (1 << 4); 
	public final static int U_EVENT = (1 << 5);
	public final static int U_REMOVE = (1 << 6); 
	public final static int U_MOREBITS1 = (1 << 7); 

	
	public final static int U_NUMBER16 = (1 << 8); 
	public final static int U_ORIGIN3 = (1 << 9);
	public final static int U_ANGLE1 = (1 << 10);
	public final static int U_MODEL = (1 << 11);
	public final static int U_RENDERFX8 = (1 << 12); 
	public final static int U_EFFECTS8 = (1 << 14); 
	public final static int U_MOREBITS2 = (1 << 15); 

	
	public final static int U_SKIN8 = (1 << 16);
	public final static int U_FRAME16 = (1 << 17); 
	public final static int U_RENDERFX16 = (1 << 18); 
	public final static int U_EFFECTS16 = (1 << 19); 
	public final static int U_MODEL2 = (1 << 20); 
	public final static int U_MODEL3 = (1 << 21);
	public final static int U_MODEL4 = (1 << 22);
	public final static int U_MOREBITS3 = (1 << 23); 

	
	public final static int U_OLDORIGIN = (1 << 24); 
	...
	public final static int SND_VOLUME = (1 << 0); 
	public final static int SND_ATTENUATION = (1 << 1); 
	public final static int SND_POS = (1 << 2); 
	public final static int SND_ENT = (1 << 3); 
	public final static int SND_OFFSET = (1 << 4); 
	...
	public final static float MIN_STEP_NORMAL = 0.7f; 

...
public class M_Boss31 {
    ...
    static final EntThinkAdapter jorg_search = new EntThinkAdapter() {
        ...
        public boolean think(edict_t self) {
            ...
            if ((double) r <= 0.3)
                ...
                game_import_t.sound(self, Defines.CHAN_VOICE, sound_search3, 1.0F,
                        (float) Defines.ATTN_NORM, (float) 0);
            return true;
        }
    };
    ...
    static EntThinkAdapter jorg_death_hit = new EntThinkAdapter() {
        ...
        @Override
        public boolean think(edict_t self) {
            game_import_t.sound(self, Defines.CHAN_BODY, sound_death_hit, 1.0F,
                    (float) Defines.ATTN_NORM, (float) 0);
            return true;
        }
    };
    ...
    static final EntThinkAdapter jorgBFG = new EntThinkAdapter() {
        ...
        public boolean think(edict_t self) {
            ...
            game_import_t.sound(self, Defines.CHAN_VOICE, sound_attack2, 1.0F,
                    (float) Defines.ATTN_NORM, (float) 0);
            /*
             ...
             * flashtype)
             */
            Monster.monster_fire_bfg(self, start, dir, 50, 300, 100, 200.0F,
    ...
    static final EntThinkAdapter jorg_attack = new EntThinkAdapter() {
        ...
        public boolean think(edict_t self) {
            ...
            if ((double) Lib.random() <= 0.75) {
                game_import_t.sound(self, Defines.CHAN_VOICE, sound_attack1, 1.0F,
                        (float) Defines.ATTN_NORM, (float) 0);
    ...
    static final mframe_t[] jorg_frames_stand = {
            new mframe_t(GameAI.ai_stand, (float) 0, jorg_idle),
            ...
            new mframe_t(GameAI.ai_stand, (float) 0, null),
            new mframe_t(GameAI.ai_stand, (float) 0, null),
            new mframe_t(GameAI.ai_stand, 19.0F, null),
            new mframe_t(GameAI.ai_stand, 11.0F, jorg_step_left),
            new mframe_t(GameAI.ai_stand, (float) 0, null),
            new mframe_t(GameAI.ai_stand, (float) 0, null),
            new mframe_t(GameAI.ai_stand, 6.0F, null),
            new mframe_t(GameAI.ai_stand, 9.0F, jorg_step_right),
            new mframe_t(GameAI.ai_stand, (float) 0, null),
            ...
            new mframe_t(GameAI.ai_stand, -17.0F, jorg_step_left),
            new mframe_t(GameAI.ai_stand, (float) 0, null),
            new mframe_t(GameAI.ai_stand, -12.0F, null),
            
            new mframe_t(GameAI.ai_stand, -14.0F, jorg_step_right)
    };
    ...
    static final mframe_t[] jorg_frames_run = {
            new mframe_t(GameAI.ai_run, 17.0F, jorg_step_left),
            ...
            new mframe_t(GameAI.ai_run, 33.0F, jorg_step_right),
            new mframe_t(GameAI.ai_run, (float) 0, null),
            new mframe_t(GameAI.ai_run, (float) 0, null),
            new mframe_t(GameAI.ai_run, (float) 0, null),
    ...
    static final mframe_t[] jorg_frames_walk = {
            new mframe_t(GameAI.ai_walk, 17.0F, null),
            ...
            new mframe_t(GameAI.ai_walk, 33.0F, null),
            new mframe_t(GameAI.ai_walk, (float) 0, null),
            new mframe_t(GameAI.ai_walk, (float) 0, null),
            new mframe_t(GameAI.ai_walk, (float) 0, null),
            new mframe_t(GameAI.ai_walk, 9.0F, null),
    ...
    static final mframe_t[] jorg_frames_pain3 = {
            new mframe_t(GameAI.ai_move, -28.0F, null),
            new mframe_t(GameAI.ai_move, -6.0F, null),
            new mframe_t(GameAI.ai_move, -3.0F, jorg_step_left),
            new mframe_t(GameAI.ai_move, -9.0F, null),
            new mframe_t(GameAI.ai_move, (float) 0, jorg_step_right),
            ...
            new mframe_t(GameAI.ai_move, 10.0F, null),
            new mframe_t(GameAI.ai_move, 7.0F, jorg_step_left),
            new mframe_t(GameAI.ai_move, 17.0F, null),
            new mframe_t(GameAI.ai_move, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, jorg_step_right) };
    ...
    static final mframe_t[] jorg_frames_death1 = {
            ...
            new mframe_t(GameAI.ai_move, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, M_Boss32.MakronToss),
    ...
    static final mframe_t[] jorg_frames_attack2 = {
            ...
            new mframe_t(GameAI.ai_charge, (float) 0, null),
            new mframe_t(GameAI.ai_charge, (float) 0, null),
            new mframe_t(GameAI.ai_charge, (float) 0, jorgBFG),
            new mframe_t(GameAI.ai_move, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, null),
    ...
    static final mframe_t[] jorg_frames_attack1 = {
            new mframe_t(GameAI.ai_charge, (float) 0, jorg_firebullet),
            new mframe_t(GameAI.ai_charge, (float) 0, jorg_firebullet),
            new mframe_t(GameAI.ai_charge, (float) 0, jorg_firebullet),
            new mframe_t(GameAI.ai_charge, (float) 0, jorg_firebullet),
            new mframe_t(GameAI.ai_charge, (float) 0, jorg_firebullet),
    ...
    static final mmove_t jorg_move_end_attack1 = new mmove_t(FRAME_attak115,
    ...
    public static void SP_monster_jorg(edict_t self) {
        ...
        sound_firegun = game_import_t.soundindex("boss3/xfire.wav");
        ...
        Math3D.VectorSet(self.mins, -80.0F, -80.0F, (float) 0);
        Math3D.VectorSet(self.maxs, 80.0F, 80.0F, 140.0F);

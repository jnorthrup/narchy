...
public class M_Medic {
    ...
    public static final int FRAME_walk1 = 0;
    ...
    public static final int FRAME_walk12 = 11;

    public static final int FRAME_wait1 = 12;
    ...
    public static final int FRAME_wait90 = 101;

    public static final int FRAME_run1 = 102;
    ...
    public static final int FRAME_run6 = 107;

    public static final int FRAME_paina1 = 108;
    ...
    public static final int FRAME_paina8 = 115;

    public static final int FRAME_painb1 = 116;
    ...
    public static final int FRAME_painb15 = 130;

    public static final int FRAME_duck1 = 131;
    ...
    public static final int FRAME_duck16 = 146;

    public static final int FRAME_death1 = 147;
    ...
    public static final int FRAME_death30 = 176;

    public static final int FRAME_attack1 = 177;
    ...
    public static final int FRAME_attack9 = 185;

    public static final int FRAME_attack10 = 186;

    public static final int FRAME_attack11 = 187;

    public static final int FRAME_attack12 = 188;

    public static final int FRAME_attack13 = 189;

    public static final int FRAME_attack14 = 190;

    public static final int FRAME_attack15 = 191;
    ...
    public static final int FRAME_attack42 = 218;

    public static final int FRAME_attack43 = 219;

    public static final int FRAME_attack44 = 220;
    ...
    public static final int FRAME_attack50 = 226;
    ...
    public static final int FRAME_attack60 = 236;
    ...
    static edict_t medic_FindDeadMonster(edict_t self) {
        ...
        while ((edit = GameBase.findradius(edit, self.s.origin, 1024.0F)) != null) {
            ent = edit.o;
            if (ent == self)
                continue;
    ...
    static final EntThinkAdapter medic_idle = new EntThinkAdapter() {
    	@Override
    ...
    static final EntThinkAdapter medic_search = new EntThinkAdapter() {
    	@Override
    ...
    static final EntInteractAdapter medic_sight = new EntInteractAdapter() {
    	@Override
    ...
    static final mframe_t[] medic_frames_stand = {
            new mframe_t(GameAI.ai_stand, (float) 0, medic_idle),
    ...
    static final mmove_t medic_move_stand = new mmove_t(FRAME_wait1, FRAME_wait90,
            medic_frames_stand, null);

    static final EntThinkAdapter medic_stand = new EntThinkAdapter() {
    	@Override
    ...
    static final mframe_t[] medic_frames_walk = {
            ...
            new mframe_t(GameAI.ai_walk, 14.0F, null),
            new mframe_t(GameAI.ai_walk, 9.3f, null) };

    static final mmove_t medic_move_walk = new mmove_t(FRAME_walk1, FRAME_walk12,
            medic_frames_walk, null);

    static final EntThinkAdapter medic_walk = new EntThinkAdapter() {
    	@Override
    ...
    static final mframe_t[] medic_frames_run = {
    ...
    static final mmove_t medic_move_run = new mmove_t(FRAME_run1, FRAME_run6,
            medic_frames_run, null);

    static final EntThinkAdapter medic_run = new EntThinkAdapter() {
    	@Override
    ...
    static final mframe_t[] medic_frames_pain1 = {
    ...
    static final mmove_t medic_move_pain1 = new mmove_t(FRAME_paina1, FRAME_paina8,
            medic_frames_pain1, medic_run);

    static final mframe_t[] medic_frames_pain2 = {
            new mframe_t(GameAI.ai_move, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, null),
    ...
    static final mmove_t medic_move_pain2 = new mmove_t(FRAME_painb1, FRAME_painb15,
            medic_frames_pain2, medic_run);

    static final EntPainAdapter medic_pain = new EntPainAdapter() {
    	@Override
    ...
    static final EntThinkAdapter medic_fire_blaster = new EntThinkAdapter() {
    	@Override
    ...
    static final EntThinkAdapter medic_dead = new EntThinkAdapter() {
    	@Override
    ...
    static final mframe_t[] medic_frames_death = {
            new mframe_t(GameAI.ai_move, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, null),
    ...
    static final mmove_t medic_move_death = new mmove_t(FRAME_death1, FRAME_death30,
            medic_frames_death, medic_dead);

    static final EntDieAdapter medic_die = new EntDieAdapter() {
    	@Override
    ...
    static final EntThinkAdapter medic_duck_down = new EntThinkAdapter() {
    	@Override
    ...
    static final EntThinkAdapter medic_duck_hold = new EntThinkAdapter() {
    	@Override
    ...
    static final EntThinkAdapter medic_duck_up = new EntThinkAdapter() {
    	@Override
    ...
    static final mframe_t[] medic_frames_duck = {
            new mframe_t(GameAI.ai_move, -1.0F, null),
            new mframe_t(GameAI.ai_move, -1.0F, null),
            new mframe_t(GameAI.ai_move, -1.0F, medic_duck_down),
            new mframe_t(GameAI.ai_move, -1.0F, medic_duck_hold),
            new mframe_t(GameAI.ai_move, -1.0F, null),
            new mframe_t(GameAI.ai_move, -1.0F, null),
            new mframe_t(GameAI.ai_move, -1.0F, medic_duck_up),
            new mframe_t(GameAI.ai_move, -1.0F, null),
            new mframe_t(GameAI.ai_move, -1.0F, null),
            new mframe_t(GameAI.ai_move, -1.0F, null),
            new mframe_t(GameAI.ai_move, -1.0F, null),
    ...
    static final mmove_t medic_move_duck = new mmove_t(FRAME_duck1, FRAME_duck16,
            medic_frames_duck, medic_run);

    static final EntDodgeAdapter medic_dodge = new EntDodgeAdapter() {
    	@Override
    ...
    static final mframe_t[] medic_frames_attackHyperBlaster = {
            new mframe_t(GameAI.ai_charge, (float) 0, null),
            new mframe_t(GameAI.ai_charge, (float) 0, null),
            new mframe_t(GameAI.ai_charge, (float) 0, null),
            new mframe_t(GameAI.ai_charge, (float) 0, null),
            new mframe_t(GameAI.ai_charge, (float) 0, medic_fire_blaster),
            new mframe_t(GameAI.ai_charge, (float) 0, medic_fire_blaster),
            new mframe_t(GameAI.ai_charge, (float) 0, medic_fire_blaster),
            new mframe_t(GameAI.ai_charge, (float) 0, medic_fire_blaster),
            new mframe_t(GameAI.ai_charge, (float) 0, medic_fire_blaster),
    ...
    static final mmove_t medic_move_attackHyperBlaster = new mmove_t(FRAME_attack15,
            FRAME_attack30, medic_frames_attackHyperBlaster, medic_run);

    static final EntThinkAdapter medic_continue = new EntThinkAdapter() {
    	@Override
        public String getID(){ return "medic_continue"; }
        @Override
        public boolean think(edict_t self) {
            if (GameUtil.visible(self, self.enemy))
                if ((double) Lib.random() <= 0.95)
                    self.monsterinfo.currentmove = medic_move_attackHyperBlaster;
            return true;
        }
    };

    static final mframe_t[] medic_frames_attackBlaster = {
            new mframe_t(GameAI.ai_charge, (float) 0, null),
            ...
            new mframe_t(GameAI.ai_charge, (float) 0, medic_fire_blaster),
            new mframe_t(GameAI.ai_charge, (float) 0, null),
            new mframe_t(GameAI.ai_charge, (float) 0, medic_continue)
                                                              
                                                              
                                                              
    };

    static final mmove_t medic_move_attackBlaster = new mmove_t(FRAME_attack1,
            FRAME_attack14, medic_frames_attackBlaster, medic_run);

    static final EntThinkAdapter medic_hook_launch = new EntThinkAdapter() {
    	@Override
        public String getID(){ return "medic_hook_launch"; }
        @Override
        public boolean think(edict_t self) {
            game_import_t.sound(self, Defines.CHAN_WEAPON, sound_hook_launch, 1.0F,
                    (float) Defines.ATTN_NORM, (float) 0);
            return true;
        }
    };

    static final float[][] medic_cable_offsets = { { 45.0f, -9.2f, 15.5f },
    ...
    static final EntThinkAdapter medic_cable_attack = new EntThinkAdapter() {
    	@Override
        ...
        public boolean think(edict_t self) {
            ...
            float[] r = {(float) 0, (float) 0, (float) 0};
            float[] f = {
                ...
                default:
                    if (self.s.frame == FRAME_attack44)
                        game_import_t.sound(self, Defines.CHAN_WEAPON,
                                sound_hook_heal, 1.0F, (float) Defines.ATTN_NORM, (float) 0);
                    break;
            }

            
            Math3D.VectorMA(start, 8.0F, f, start);
    ...
    static final EntThinkAdapter medic_hook_retract = new EntThinkAdapter() {
    	@Override
        public String getID(){ return "medic_hook_retract"; }
        @Override
        public boolean think(edict_t self) {
            game_import_t.sound(self, Defines.CHAN_WEAPON, sound_hook_retract, 1.0F,
                    (float) Defines.ATTN_NORM, (float) 0);
            self.enemy.monsterinfo.aiflags &= ~Defines.AI_RESURRECTING;
            return true;
        }
    ...
    static final mframe_t[] medic_frames_attackCable = {
            ...
            new mframe_t(GameAI.ai_charge, (float) 0, null),
            new mframe_t(GameAI.ai_move, (float) 0, medic_hook_launch),
            new mframe_t(GameAI.ai_move, (float) 0, medic_cable_attack),
            new mframe_t(GameAI.ai_move, (float) 0, medic_cable_attack),
            new mframe_t(GameAI.ai_move, (float) 0, medic_cable_attack),
            new mframe_t(GameAI.ai_move, (float) 0, medic_cable_attack),
            new mframe_t(GameAI.ai_move, (float) 0, medic_cable_attack),
            ...
            new mframe_t(GameAI.ai_move, (float) 0, medic_cable_attack),
            new mframe_t(GameAI.ai_move, (float) 0, medic_cable_attack),
            new mframe_t(GameAI.ai_move, -15.0F, medic_hook_retract),
    ...
    static final mmove_t medic_move_attackCable = new mmove_t(FRAME_attack33,
            FRAME_attack60, medic_frames_attackCable, medic_run);

    static final EntThinkAdapter medic_attack = new EntThinkAdapter() {
    	@Override
    ...
    static final EntThinkAdapter medic_checkattack = new EntThinkAdapter() {
    	@Override

...
import spacegraph.slam.ExampleStereoTwoViewsOneCamera2;
...
public class ExampleStereoTwoViewsOneCamera {
    ...
    private static final int minDisparity = 4;
    private static final int maxDisparity = 100;
    public final static CameraPinholeRadial intrinsic = CalibrationIO.load(new StringReader(
            "# Pinhole camera model with radial and tangential distortion\n" +
                    ...
                    "\n" +
                    "pinhole:\n" +
                    "  fx: 752.0116882676376\n" +
                    "  fy: 416.6537946928421\n" +
                    "  cx: 375.4551818095542\n" +
                    "  cy: 208.84300560315452\n" +
                    "  width: 752\n" +
                    "  height: 416\n" +
                    "  skew: 0.0\n" +
...
//        String imageDir = UtilIO.pathExample("stereo/");
        ...
        BufferedImage origLeft = UtilImageIO.loadImage("/tmp/i1.png");
        BufferedImage origRight = UtilImageIO.loadImage("/tmp/i3.png");
        ...
        StereoDisparity<GrayS16, GrayF32> disparityAlg =
                FactoryStereoDisparity.regionSubpixelWta(DisparityAlgorithms.RECT_FIVE,
                        minDisparity, maxDisparity, 5, 5, 55, 1, 0.1, GrayS16.class);
...
//		DetectDescribePoint detDesc = FactoryDetectDescribe.sift(null,new ConfigSiftDetector(2,0,200,5),null,null);
            ...
            ExampleStereoTwoViewsOneCamera2.ExampleAssociatePoints<GrayF32, BrightFeature> findMatches =

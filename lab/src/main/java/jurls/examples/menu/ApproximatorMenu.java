...
public class ApproximatorMenu extends RLMenu {
    ...
    public class NumberOfBitsMenu extends JMenu {
        ...
        public JRadioButtonMenuItem bits8 = new JRadioButtonMenuItem(new MyAction("8"));
        public JRadioButtonMenuItem bits10 = new JRadioButtonMenuItem(new MyAction("10"));
        public JRadioButtonMenuItem bits12 = new JRadioButtonMenuItem(new MyAction("12"));
        public JRadioButtonMenuItem bits16 = new JRadioButtonMenuItem(new MyAction("16"));
    ...
    public class ActivationFunctionMenu extends JMenu {
        ...
        public JRadioButtonMenuItem atan = new JRadioButtonMenuItem(new MyAction("atan"));
        public JRadioButtonMenuItem tanh = new JRadioButtonMenuItem(new MyAction("tanh"));
        public JRadioButtonMenuItem logistic = new JRadioButtonMenuItem(new MyAction("logistic sigmoid"));
        public JRadioButtonMenuItem rbf = new JRadioButtonMenuItem(new MyAction("radial basis function"));
    ...
    public JRadioButtonMenuItem fourier = new JRadioButtonMenuItem(new MyAction("Fourier Basis"));
    public JRadioButtonMenuItem wavelet = new JRadioButtonMenuItem(new MyAction("Wavelet"));
    public JRadioButtonMenuItem neuralNet = new JRadioButtonMenuItem(new MyAction("Neural Net"));
    public JRadioButtonMenuItem cnf = new JRadioButtonMenuItem(new MyAction("CNF Function"));
    ...
    public JCheckBoxMenuItem normalizeInput = new JCheckBoxMenuItem(new MyAction("Normalize Input"));
    public JCheckBoxMenuItem normalizeOutput = new JCheckBoxMenuItem(new MyAction("Normalize Output"));
    public NumberOfBitsMenu numberOfInputBitsMenu = new NumberOfBitsMenu("input");
    public NumberOfBitsMenu numberOfOutputBitsMenu = new NumberOfBitsMenu("output");
    public ObjectListMenu featuresMenu = new ObjectListMenu(
            "No. Features", 2, 1, 3, 5, 7, 9
    );

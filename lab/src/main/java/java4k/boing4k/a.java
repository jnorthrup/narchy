...
public class a extends GamePanel {
	...
	static final int TILE_QUESTION = 2;
	static final int TILE_UP = 3;
	static final int TILE_DOUBLE_UP = 4;
	static final int TILE_EXCLAMATION = 5;
	static final int TILE_PAUSE = 6;
	static final int TILE_GREEN = 7;
	static final int TILE_CHECKER = 8;
	static final int TILE_RIGHT = 11;
	static final int TILE_DOUBLE_RIGHT = 12;
	static final int TILE_DOWN = 19;
	static final int TILE_DOUBLE_DOWN = 20;
	static final int TILE_LEFT = 27;
	static final int TILE_DOUBLE_LEFT = 28;
	...
	static final float HIGH_GRAVITY = 0.8f;
	static final float JUMP_SPEED = 11.25f;
	static final float V_ANGLE = 0.1122f;

	static final float yy = 0.921061f;
	static final float zy = 0.389418f;

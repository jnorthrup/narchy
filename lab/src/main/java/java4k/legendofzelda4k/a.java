...
public class a extends GamePanel {
  ...
  public void run() {
    ...
    var candleLight = new BufferedImage(112, 112, 2);
    for(i = 0; i < 112; i++) {
      for(j = 0; j < 112; j++) {
        var X = 55.5f - j;
        var Y = 55.5f - i;
    ...
    var map = new int[81][81];
    int k;
    final var MAP_OFFSET = SPRITE_COUNT << 5;
    final var MAP_WALL = 8;
    ...
    final var MAP_SWORD = 1;
    map[45][31] = MAP_SWORD;
    final var MAP_CANDLE = 2;
    map[51][3] = MAP_CANDLE;
    final var MAP_KEY = 3;
    map[14][51] = MAP_KEY;
    map[27][60] = MAP_KEY;
    map[17][43] = MAP_KEY;
    map[3][53] = MAP_KEY;
    final var MAP_LOCK = 9;
    map[34][3] = MAP_LOCK;
    map[5][29] = MAP_LOCK;
    map[4][43] = MAP_LOCK;
    map[8][70] = MAP_LOCK;
    final var MAP_PRINCESS = 4;
    map[3][77] = MAP_PRINCESS;
    final var MAP_CRACKED_WALL = 10;
    map[27][15] = MAP_CRACKED_WALL;


    final var MAP_WATER = 11;
    for(i = 0; i < 23; i++) {
      if (i != 6) {
    ...
    final var MAP_BRIDGE = 6;
    map[38][5] = map[38][6] = MAP_BRIDGE;

    var image = new BufferedImage(256, 240, 1);
    ...
    var flash = false;
    var scrolling = true;
    var acquiredKey = false;
    var acquiredCandle = false;
    var acquiredSword = true;
    ...
    var s = 0;
    var r = 0;
    var COLOR_RED = new Color(0xB53120);
    var COLOR_MAP_2 = new Color(0x88D800);
    var COLOR_MAP_1 = new Color(0x666666);
    var COLOR_FLOOR = new Color(0xF7D8A5);
    final var ENEMY_DYING = 5;
    final var ENEMY_COUNTER = 4;
    final var ENEMY_DIRECTION = 3;
    final var ENEMY_SPRITE = 2;
    final var ENEMY_Y = 1;
    final var ENEMY_X = 0;
    final var SPRITE_LOCK = 17;
    final var SPRITE_TRIFORCE = 16;
    final var SPRITE_KEY = 15;
    final var SPRITE_HEART = 14;
    final var SPRITE_CANDLE = 13;
    final var SPRITE_OCTOROC_2 = 12;
    final var SPRITE_OCTOROC_1 = 11;
    final var SPRITE_SWORD = 8;
    final var SPRITE_LINK_LEFT_LUNGE = 5;
    final var SPRITE_LINK_RIGHT_LUNGE = SPRITE_LINK_LEFT_LUNGE + SPRITE_FLIPPED;
    final var SPRITE_LINK_LEFT_2 = 4;
    final var SPRITE_LINK_RIGHT_2 = SPRITE_LINK_LEFT_2 + SPRITE_FLIPPED;
    final var SPRITE_LINK_LEFT_1 = 3;
    final var SPRITE_LINK_RIGHT_1 = SPRITE_LINK_LEFT_1 + SPRITE_FLIPPED;
    final var SPRITE_LINK_UP_LUNGE = 7;
    final var SPRITE_LINK_UP_1 = 6;
    final var SPRITE_LINK_UP_2 = SPRITE_LINK_UP_1 + SPRITE_FLIPPED;
    final var SPRITE_LINK_DOWN_LUNGE = 2;
    final var SPRITE_LINK_DOWN_2 = 1;
    final var SPRITE_LINK_DOWN_1 = 0;
    final var MAP_HEART = 5;
    final var DIRECTION_UP = 3;
    final var DIRECTION_LEFT = 2;
    final var DIRECTION_DOWN = 1;
    final var DIRECTION_RIGHT = 0;
    ...
    while(true) {
      ...
      if (won) {
        ...
        if (attacking > 0) {
          ...
          var angle = 1.57f * (playerDirection - 1);
            switch (playerDirection) {
                case DIRECTION_UP:
                    i -= 2;
                    break;
  ...
  public static void main(String[] args) throws Throwable {
    var frame = new javax.swing.JFrame("Legend of Zelda 4K");

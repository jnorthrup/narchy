...
//        super(id, nar);
//        spec = new AgentBuilder(ctl, () -> reward);
//    }
//
//    @Override
...
//
//    @Override
//    public @Nullable void actionToggle(@NotNull Term t, float threshUnused, float defaultUnused, float momentumOn, @NotNull Runnable on, @NotNull Runnable off) {
//

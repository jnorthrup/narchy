...
public class Curiosity {
    ...
    public final FloatRange conf = new FloatRange(0, Param.truth.TRUTH_EPSILON, Param.truth.TRUTH_CONF_MAX);
    ...
    private void update(NAR nar) {
        ...
        conf.set(Util.clamp(curiConf, nar.confMin.floatValue(), Param.truth.TRUTH_CONF_MAX));

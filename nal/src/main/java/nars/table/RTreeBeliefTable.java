...
//                }
    ...
    boolean ensureCapacity(Space<TaskRegion> treeRW, @Nullable Task inputRegion, Consumer<Tasked> added, NAR nar) {
...
//        }
    ...
    protected void eternalize(Task x, Consumer<Tasked> added, NAR nar) {

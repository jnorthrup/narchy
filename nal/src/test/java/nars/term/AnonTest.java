    ...
    private static void testAnonTermVectorProducedByTermBuilder(TermBuilder b) {
        {
            ...
            assertEquals(AnonVector.class, tri.getClass());
        }

        {
            Term triSub = b.compound(Op.PROD, $.varDep(1), Anom.the(2), Anom.the(1));
            assertEquals(AnonVector.class, triSub.subterms().getClass());
        }

        {
            Subterms bi = b.subterms($.varDep(1), Anom.the(2));
            assertEquals(AnonVector.class, bi.getClass());
        }

        {
            Term biSub = b.compound(Op.PROD, $.varDep(1), Anom.the(2));
            assertEquals(AnonVector.class, biSub.subterms().getClass());
        }

        {
            Subterms uni = b.subterms($.varDep(1));
            assertEquals(AnonVector.class, uni.getClass());
        }
        {
            Term uniSub = b.compound(PROD, $.varDep(1));
            assertEquals(AnonVector.class, uniSub.subterms().getClass());
        }
    }

    ...
    static class ReverseTest extends ListFuncTest {
        ...
        void testReverseForwards() {
            assertEquals(
                    ...
                    Evaluation.solveAll($$("reverse((x,y),#1)"), n));
        }
        ...
        void testReverseInline() {
            assertEquals(
                    Set.of($$("(y,x)")),
                    Evaluation.solveAll($$("reverse((x,y))"), n));
        }
        ...
        void testReverseBackwards() {
            assertEquals(
                    ...
                    Evaluation.solveAll($$("reverse(#1,(x,y))"), n));
        }
        ...
        void testReverseTrue() {
            ...
            assertEquals(
                    Set.of($$("reverse((y,x),(x,y))")),
                    Evaluation.solveAll($$("reverse((y,x),(x,y))"), n));
        }
        ...
        void testReverseFalse() {
            ...
            assertEquals(
                    ...
                    Evaluation.solveAll($$("reverse((x,y),(x,y))"), n));
        ...
        void testReverseReverse() {
            assertEquals(
                    ...
                    Evaluation.solveAll($$("(reverse((x,y),#1) && reverse(#1,#2))"), n));
        }

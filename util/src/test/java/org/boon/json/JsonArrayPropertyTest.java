...
public class JsonArrayPropertyTest {
    ...
    public static Collection<Object[]> data() {
        Object[][] data = new Object[][] { { new ObjectMapperImpl(new JsonParserFactory().usePropertyOnly().acceptSingleValueAsArray(), new JsonSerializerFactory().usePropertyOnly()) }, { new ObjectMapperImpl(new JsonParserFactory().useFieldsOnly().acceptSingleValueAsArray(), new JsonSerializerFactory().useFieldsOnly()) } };

...
public class JsonSerializeTest {
    ...
    public void testWithJSONStringArray() {
        ...
        Assertions.assertArrayEquals(cats, gatos);
    }
    ...
    public void testWithIntArray() {
        ...
        Assertions.assertArrayEquals(numbers, numeros);
    }
    ...
    public void testWithObjectArray() {
        ...
        Assertions.assertArrayEquals(dogs, peros);
    }
    ...
    public void testWithType() {
        Employee rick = new Employee();
        String sRick = new JsonSerializerFactory().useFieldsFirst().setOutputType(true).create().serialize(rick).toString();
        puts(sRick);
    ...
    public void testBug() {
        Employee rick = new Employee();
        JsonSerializer serializer = new JsonSerializerFactory().setIncludeEmpty(true).setUseAnnotations(false).setCacheInstances(false).setIncludeNulls(true).create();
    ...
    public void bug2() {
        Employee rick = new Employee();
        JsonSerializer serializer = new JsonSerializerFactory().setIncludeEmpty(true).setUseAnnotations(false).setCacheInstances(false).create();
        String sRick = serializer.serialize(rick).toString();
        outputs(sRick);
        AllTypes foo = new AllTypes();
        foo.ignoreMe = "THIS WILL NOT PASS";
    ...
    private static Map<String, Object> generateMediumData() {
        try {
            ...
            data.put("about", "I am Java/Groovy developer with more than 10 years of experience in software design and development. I has been involved in several high load web projects. Also I am contributing some open source projects.\nAll free time I dedicate to my family. We love travelling in new interesting places.");
    ...
    private static List<Object> generateComplexData() {
        ...
        headers4.put("To", new String[] { "shanna.husser@enron.com", "bryan.hull@enron.com", "timothy.blanchard@enron.com", "matthew.lenhart@enron.com", "david.baumbach@enron.com", "phillip.love@enron.com", "patrick.ryder@enron.com" });
    ...
    public void includeEmptyString() {
        ...
        Assertions.assertEquals("{\"name\":\"mittens\",\"type\":\"calico\",\"sex\":\"\"}", String.valueOf(new JsonSerializerFactory().setIncludeEmpty(true).create().serialize(mittens)));
    }
    ...
    public void excludeEmptyString() {
        Cat mittens = new Cat("mittens", "calico", "");
        Assertions.assertEquals("{\"name\":\"mittens\",\"type\":\"calico\"}", Boon.toJson(mittens));
    }
}

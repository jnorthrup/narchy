 ...
 */
public class JsonCaseInsensitiveReaderPropertiesFieldsTest {

    private ObjectMapper objectMapper;

    @BeforeEach
    public void setUp() throws Exception {
        objectMapper = new ObjectMapperImpl(new JsonParserFactory().usePropertiesFirst().caseInsensitiveFields(), new JsonSerializerFactory().usePropertiesFirst());
    }

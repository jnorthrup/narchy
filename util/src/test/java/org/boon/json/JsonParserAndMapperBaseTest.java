...
public class JsonParserAndMapperBaseTest {
    ...
    @Test
    public void classic() {
        Map<String, Object> map = (Map<String, Object>) jsonParserAndMapper.parse(Map.class, lines("{ \"nums\": [12, 12345678, 999.999, 123456789.99],\n " + "    \"nums2\": [12, 12345678, 999.999, 123456789.99],\n" + "    \"nums3\": [12, 12345678, 999.999, 123456789.99]\n" + "}"));
    }

    @Test
    public void bugReport179() {
        Map<String, Object> map = (Map<String, Object>) jsonParserAndMapper.parse(Map.class, lines("{ \"nums\": [-0, 12345678, 999.999, 123456789.99],\n " + "    \"nums2\": [12, 12345678, 999.999, 123456789.99],\n" + "    \"nums3\": [12, 12345678, 999.999, 123456789.99]\n" + "}"));
    ...
    public void simpleFloat2() {
        Map<String, Object> map = (Map<String, Object>) jsonParserAndMapper.parse(lines("{ \"v\":1.1}"));
        Object o = map.get("v");
    ...
    public void roundTrip() {
        ...
        final JsonSerializer serializer = new JsonSerializerFactory().useAnnotations().addFilter(new FieldFilter() {
            ...
            public boolean serializeField(JsonSerializerInternal serializer, Object parent, FieldAccess fieldAccess, CharBuf builder) {
                if (fieldAccess.type().equals(long.class) && fieldAccess.name().endsWith("Date")) {
    ...
    public void testParserSimpleMapWithNumber() {
        Object obj = jsonParserAndMapper.parse(Map.class, new StringReader(" { 'foo': 1 }  ".replace('\'', '"')));
        boolean ok = true;
    ...
    @Test
    public void objectSerialization() throws URISyntaxException {
        String fileContents = IO.read(BoonTest.resource("files/AllTypes.json"));
        ...
        ok |= gmtString.equals("14/12/2013 01:55") || die("" + gmtString);
    ...
    @Test
    public void objectSerializationList() throws URISyntaxException {
        String fileContents = IO.read(BoonTest.resource("files/arrayOfAllType.json"));
    ...
    public void testFilesFromReader() throws Exception {
        boolean fail = false;
        final List<String> list = IO.listByExt(BoonTest.resource("files"), ".json");
    ...
    public void testParseFalse() {
        Object obj = jsonParserAndMapper.parseMap(new String(" { 'foo': false }  ".replace('\'', '"')));
        boolean ok = true;
        ok &= obj instanceof Map || die("Object was not a map");
        Map<String, Object> map = (Map<String, Object>) obj;
        System.out.println(obj);
    ...
    public void testParseNull() {
        Object obj = jsonParserAndMapper.parse(" { 'foo': null }  ".replace('\'', '"'));
        boolean ok = true;
        ok &= obj instanceof Map || die("Object was not a map");
        Map<String, Object> map = (Map<String, Object>) obj;
        System.out.println(obj);
    ...
    public void testParserSimpleMapWithBoolean() {
        Object obj = jsonParserAndMapper.parse(" { 'foo': true }  ".replace('\'', '"'));
        boolean ok = true;
        ok &= obj instanceof Map || die("Object was not a map");
        Map<String, Object> map = (Map<String, Object>) obj;
        System.out.println(obj);
    ...
    public void testParserSimpleMapWithList() {
        Object obj = jsonParserAndMapper.parse(new String(" { 'foo': [0,1,2 ] }  ".replace('\'', '"')));
        boolean ok = true;
        ok &= obj instanceof Map || die("Object was not a map");
        Map<String, Object> map = (Map<String, Object>) obj;
        System.out.println(obj);
    ...
    public void testParserList() {
        Object obj = jsonParserAndMapper.parse(new StringReader("[0,1,2]".replace('\'', '"')));
        List list = (List) obj;
    ...
    public void testParserSimpleMapWithString() {
        Object obj = jsonParserAndMapper.parse(" { 'foo': 'str ' }  ".replace('\'', '"'));
        boolean ok = true;
        System.out.println("%%%%%%" + obj);
        ok &= obj instanceof Map || die("Object was not a map");
        Map<String, Object> map = (Map<String, Object>) obj;
    ...
    public void testLists() {
        String[][] testLists = { //0
                {"emptyList", "[]"}, //1  fails
                {"emptyList", " [ ]"}, //2
                {"oddly spaced", "[ 0 , 1 ,2, 3, '99' ]"}, //3
                {"nums and strings", "[ 0 , 1 ,'bar', 'foo', 'baz' ]"}, //4
                {"nums stings map", "[ 0 , 1 ,'bar', 'foo', {'baz':1} ]"}, //5
                {"nums strings map with listStream", "[ 0 , 1 ,'bar', 'foo', {'baz':1, 'lst':[1,2,3]} ]"}, //6
                {"nums strings map with listStream", "[ {'bar': {'zed': 1}} , 1 ,'bar', 'foo', {'baz':1, 'lst':[1,2,3]} ]"}, {"tightly spaced", "[0,1,2,3,99]"}};
        List<?>[] lists = { //0
                Collections.EMPTY_LIST, //1
                Collections.EMPTY_LIST, //2
                Lists.list(0, 1, 2, 3, "99"), //3
                Lists.list(0, 1, "bar", "foo", "baz"), //4
                Lists.list(0, 1, "bar", "foo", map("baz", 1)), Lists.list(0, 1, "bar", "foo", map("baz", 1, "lst", list(1, 2, 3))), //6
                Lists.list(map("bar", map("zed", 1)), 1, "bar", "foo", map("baz", 1, "lst", list(1, 2, 3))), Lists.list(0, 1, 2, 3, 99)};
    ...
    public void helper(String name, String json, Object compareTo) {
        ...
        Object obj = jsonParserAndMapper.parse(json.replace('\'', '"'));
        boolean ok = true;
    ...
    public void testNumber() {
        Object obj = jsonParserAndMapper.parse(Integer.class, "1".replace('\'', '"'));
        boolean ok = true;
    ...
    public void testBoolean() {
        Object obj = jsonParserAndMapper.parse(boolean.class, "  true  ".replace('\'', '"'));
        boolean ok = true;
    ...
    @Test public void testBooleanParseError() {
        assertThrows(JsonException.class, () -> {
            Object obj = jsonParserAndMapper.parse(Map.class, "  tbone  ".replace('\'', '"'));
            boolean ok = true;
            ok &= obj instanceof Boolean || die("Object was not a Boolean");
            boolean value = (Boolean) obj;
            ok &= value == true || die("I did see value equal to true");
    ...
    public void testString() {
        String testString = ("  'this is all sort of text, " + "   do you think it is \\'cool\\' '").replace('\'', '"');
    ...
    public void testStringInsideOfList() {
        ...
        assertEquals("this is all sort of text,    do you think it is \"cool\" ", Lists.idx(value, 0));
        System.out.println(obj.getClass());
    }

    @Test
    public void testStringInsideOfList2() {
        String testString = "[ 'abc','def' ]".replace('\'', '"');
        Object obj = jsonParserAndMapper.parse(testString);
        System.out.println("here is what I got " + obj);
        boolean ok = true;
        ok &= obj instanceof List || die("Object was not a List");
        List<String> value = (List<String>) obj;
        assertEquals("abc", Lists.idx(value, 0));
        System.out.println(obj.getClass());
    }
    ...
    public void textInMiddleOfArray() {
        try {
            Object obj = jsonParserAndMapper.parse(Map.class, lines("[A, 0]").replace('\'', '"').getBytes(StandardCharsets.UTF_8));
        } catch (Exception ex) {
            //success
            return;
        }
    ...
    public void oddlySpaced2() {
        Object obj = jsonParserAndMapper.parse(lines("[   2   ,    1, 0]").replace('\'', '"'));
        boolean ok = true;
        System.out.println(obj);
    }
    ...
    @Test
    public void complex() {
        Object obj = jsonParserAndMapper.parse(lines("{    'num' : 1   , ", "     'bar' : { 'foo': 1  },  ", "     'nums': [0  ,1,2,3,4,5,'abc'] } ").replace('\'', '"').getBytes(StandardCharsets.UTF_8));
        boolean ok = true;
        System.out.println(obj);
        //die();
    }
    ...
    @Test
    public void bug2() {
        Object obj = jsonParserAndMapper.parse(lines("    [ {'bar': {'zed': 1}} , 1]\n ").replace('\'', '"').getBytes(StandardCharsets.UTF_8));
        boolean ok = true;
        System.out.println(obj);
        //die();
    }
    ...
    public void complianceFromJsonSmartForPI() {
        Map<String, Object> map = (Map<String, Object>) jsonParserAndMapper.parse(lines("{ \"PI\":3.141E-10} "));
        Object o = map.get("PI");
        if (o instanceof BigDecimal) {
            o = ((BigDecimal) o).doubleValue();
        }
    ...
    public void complianceForLowerCaseNumber() {
        Map<String, Object> map = (Map<String, Object>) jsonParserAndMapper.parse(lines("{ \"v\":\"\\u00c1\\u00e1\"}"));
        //puts ( map );
    ...
    public void doublePrecisionFloatingPoint() {
        Map<String, Object> map = (Map<String, Object>) jsonParserAndMapper.parse(lines("{ \"v\":1.7976931348623157E308}"));
        Object o = map.get("v");
        if (o instanceof BigDecimal) {
            o = ((BigDecimal) o).doubleValue();
        }
    ...
    @Test public void doubleQuoteInsideOfSingleQuote() {
        assertThrows(JsonException.class, () -> {
            Map<String, Object> map = (Map<String, Object>) jsonParserAndMapper.parse(Map.class, lines("{ \"v\":'ab\"c'}"));
        });
    }


    @Test public void supportSimpleQuoteInNonProtectedStringValue() {
        assertThrows(JsonException.class, () -> {
            Map<String, Object> map = (Map<String, Object>) jsonParserAndMapper.parse(Map.class, lines("{ \"v\":It's'Work}"));
        });
    }


    @Test public void supportNonProtectedStrings() {
        assertThrows(JsonException.class, () -> {
            Map<String, Object> map = (Map<String, Object>) jsonParserAndMapper.parse(Map.class, lines("{ a:1234}"));
        });
    }
    ...
    public void crapInAnArray() {
        assertThrows(JsonException.class, ()-> {
            Map<String, Object> map = (Map<String, Object>) jsonParserAndMapper.parse(Map.class, lines("[ a,bc]"));
        });
    }
    ...
    public void randomStringAsValuesWithSpaces() {
        assertThrows(JsonException.class, ()-> {
            Map<String, Object> map = (Map<String, Object>) jsonParserAndMapper.parse(Map.class, lines("{ \"v\":s1 s2}"));
        });
    }
    ...
    public void garbageAtEndOfString() {
        Map<String, Object> map = (Map<String, Object>) jsonParserAndMapper.parse(lines("{ \"a\":\"foo.bar\"}#toto"));
        //puts ( map );
    }
    ...
    public void singleQuotes() {
        assertThrows(JsonException.class, ()-> {
            Map<String, Object> map = (Map<String, Object>) jsonParserAndMapper.parse(lines("{ 'value':'string'}"));
        });
    }
    ...
    public void testArrayOfArrayWithSimpleValues() {
        boolean ok = jsonParserAndMapper.parse("[1, 2, 3, [\"a\", \"b\", \"c\", [true, false], \"d\"], 4]").equals(list(1, 2, 3, list("a", "b", "c", list(true, false), "d"), 4)) || die();

...
public class ListsTest {
    ...
    public void iterAndFriends() {
        List<String> list = list("apple", "oranges", "pears", "grapes", "kiwi");
        iterAndFriends(list);
        list = safeList("apple", "oranges", "pears", "grapes", "kiwi");
        iterAndFriends(list);
        list = linkedList("apple", "oranges", "pears", "grapes", "kiwi");
        iterAndFriends(list);
        list = linkedList(list);
        iterAndFriends(list);
        list = safeList(list);
        iterAndFriends(list);
        list = copy(safeList(list));
        iterAndFriends(list);
        list = copy(linkedList(list));
        iterAndFriends(list);
        list = copy(list(list));
        iterAndFriends(list);
    }
    ...
    public void tooBigIndex() {
        List<String> list = list("apple", "oranges", "pears");
        idx(list, 100);
        slc(list, -100);
        slc(list, 100);
    }

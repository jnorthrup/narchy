...
public class CreatorTest {
    ...
    public void testCreateWithInstance4() {
        Foo foo = newOf(fooType, "bar", map("class", "org.boon.di.CreatorTest$Bar", "name", "barFromMap"));
        boolean ok = foo != null || die();
        ok = foo.bar != null || die();
    ...
    public void testCreateWithInstance6() {
        Foo foo = create(fooType, map("bar", map("class", "org.boon.di.CreatorTest$Bar", "name", "barFromMap")));
        boolean ok = foo != null || die();
        ok = foo.bar != null || die();
        ok = foo.bar.name.equals("barFromMap") || die();
    }
    ...
    public void testCreateWithStuff() {
        Foo foo = newOf(fooType, "bar", Bar.class, "someClass", new SomeClass(), "object2", SomeClass.class);
        boolean ok = foo != null || die();
        ok = foo.bar != null || die();
    ...
    public void testCreateWithStuff2() {
        Foo foo = newOf(fooType, "bar", Bar.class, "someClass", new SomeClass());
        boolean ok = foo != null || die();
        ok = foo.bar != null || die();
        ok = foo.object != null || die();
        ok = foo.object2 != null || die();

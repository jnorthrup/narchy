...
public class InvokerTest {
    ...
    public void invokeObj() {
        ...
        Rights rights = Rights.createRights(RightsType.AMAZON_PRIME, true, TimeZoneType.EST, System.currentTimeMillis());
        RightsCrudRequest rightsCrudRequest = new RightsCrudRequest("Bob", CrudType.ADD, rights);
    ...
    public static class HelloWorldArg {
        ...
        public boolean equals(Object o) {
            ...
            if (i != that.i)
                return false;
            if (hello != null ? !hello.equals(that.hello) : that.hello != null)
                return false;
            return true;
        }
    ...
    public void testBug159() {
        String value = (String) Invoker.invokeFromObject(new HelloWorld(), "sayHi", Lists.list("Rick"));
        puts(value);
    ...
    public void testComplex() {
        HelloWorldArg message = (HelloWorldArg) Invoker.invokeFromList(new HelloWorld(), "sayArg", Lists.list(Lists.list("1", "Hello"), 1));
    ...
    public void testComplex2() {
        HelloWorldArg message = (HelloWorldArg) Invoker.invokeFromObject(new HelloWorld(), "sayArg2", Lists.list("1", "Hello"));
        if (!message.equals(new HelloWorldArg(1, "Hello"))) {
            die();
        }
    }
    ...
    public void testComplex3() {
        HelloWorldArg message = (HelloWorldArg) Invoker.invokeFromList(new HelloWorld(), "sayArg2", Lists.list((Object) Lists.list("1", "Hello")));
        if (!message.equals(new HelloWorldArg(1, "Hello"))) {
            die();
        }
    }
    ...
    public void testComplex4() {
        HelloWorldArg message = (HelloWorldArg) Invoker.invokeFromList(new HelloWorld(), "sayArg2", Lists.list(Maps.map("i", "1", "hello", "Hello")));
        if (!message.equals(new HelloWorldArg(1, "Hello"))) {
            die();
        }
    }

...
public class BeanUtilsTest {
    ...
    public static class TestClass {
        ...
        List<Player> players = Player.players(Player.player("1", "Rick", "Hightower"), Player.player("2", "Diana", "Hightower"));
        ...
        public boolean equals(Object o) {
            ...
            if (child != null ? !child.equals(testClass.child) : testClass.child != null)
                return false;
            if (id != null ? !id.equals(testClass.id) : testClass.id != null)
                return false;
            if (players != null ? !players.equals(testClass.players) : testClass.players != null)
                return false;
            if (!Arrays.equals(score, testClass.score))
                return false;
            if (time != null ? !time.equals(testClass.time) : testClass.time != null)
                return false;
            return true;
        }
    ...
    @Test
    public void bug75() {
        Employee rick = new Employee("Rick", "Hightower", 66, new Phone("320", "555", "1212"), Fruit.ORANGES, Fruit.APPLES, Fruit.STRAWBERRIES);
        final List<Dept> list = Lists.list(new Dept("Engineering", rick), new Dept("HR", new Employee("Diana", "Hightower", 2, new Phone("320", "555", "1212"))));

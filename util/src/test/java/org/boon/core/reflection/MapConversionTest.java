...
public class MapConversionTest {
    ...
    public static class Employee {
        ...
        public String toString() {
            return "Employee{" + "name='" + name + '\'' + ", age=" + age + ", boss=" + (boss == null ? "executive" : boss) + //                    ", reports=" + reports +
            ", dob=" + dob + ", currency=" + currency + ", salary=" + salary + '}';
        }
    }
    ...
    public static void main(String... args) {
        ...
        /** Creating a map. */
        rickMap = map("name", "Rick", "age", 29, "boss", map("name", "Jason", "age", 21));

...
public class OverloadedMethodTest {
    ...
    public void testTwoEmployeeWithMap() {
        String str = (String) method.invokeDynamic(new SomeClass(), Maps.map("name", "emp1"), Maps.map("name", "emp2"));
        puts(str);
    ...
    public void testTwoEmployeeWithList() {
        String str = (String) method.invokeDynamic(new SomeClass(), Lists.list("emp1"), Lists.list("emp2"));
        puts(str);
        equalsOrDie("addTwoEmployeesEmployee{name='emp1'}_Employee{name='emp2'}", str);
    }

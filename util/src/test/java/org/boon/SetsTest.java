...
public class SetsTest {
    ...
    @Test
    public void simple() {
        Set<String> set = set("apple", "oranges", "pears", "grapes", "kiwi");
    ...
    @Test
    public void sorted() {
        NavigableSet<String> set = sortedSet("apple", "kiwi", "oranges", "pears", "pineapple");
        assertEquals(5, len(set));
        assertTrue(in("apple", set));
        assertEquals("oranges", idx(set, "ora"));
    ...
    public void creationalEquals() {
        assertTrue(sortedSet("apple", "pear", "orange").equals(set("apple", "pear", "orange")) && safeSet("apple", "pear", "orange").equals(safeSortedSet("apple", "pear", "orange")) && sortedSet("apple", "pear", "orange").equals(safeSortedSet("apple", "pear", "orange")));
    }
    ...
    private void simpleOperations(Set<String> set) {
        add(set, "apple");
        assertTrue(len(set) == 1);
        assertTrue(!(set instanceof SortedSet) || idx(set, "a").equals("apple"));
        Set<String> set2 = copy(set);
        assertTrue(!(set2 instanceof SortedSet) || idx(set2, "a").equals("apple"));
        assertTrue(len(set2) == 1);
    }

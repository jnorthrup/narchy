...
public class StrTest {
    ...
    public void slice() {
        String letters = "abcd";
        assertEquals("ab", slc(letters, 0, 2));
        assertEquals("bc", slc(letters, 1, -1));
        //>>> letters[2:]
        //['c', 'd']
        //>>> letters[-2:]
        //['c', 'd']
        assertEquals("cd", slc(letters, -2));
        assertEquals("cd", slc(letters, 2));
        //>>> letters[:-2]
        //     ['a', 'b']
        assertEquals("ab", slcEnd(letters, -2));
        //>>> letters[:-2]
        //     ['a', 'b']
        assertEquals("ab", slcEnd(letters, 2));
    }
    ...
    public void outOfBounds() {
        ...
        assertEquals('x', idx(letters, -1));
        assertEquals('z', idx(letters, 0));
    }

    @Test
    public void compactTest() {
        String letters = "ab\0\0\0\0\0\0c\0d\0\0e";
    ...
    @Test
    public void lines() {
        String foo = Str.lines("Line 1", "Line 2", "Line 3");
        boolean ok = true;

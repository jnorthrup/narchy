...
public class ZipFileSystemTest {
    ...
    public static void main(String... args) throws Exception {
        ...
        String someResource = //It also works with directories
        args.length > 0 ? args[0] : "classpath:///org/node/";
        ...
        URLClassLoader loader = new URLClassLoader(new URL[] { url, new File("files/invoke-1.0-SNAPSHOT.jar").getAbsoluteFile().toURI().toURL() });

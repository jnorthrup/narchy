...
public abstract class MeasuredRun implements Runnable {
    ...
    public MeasuredRun(String name, int warmupCount, int iterations, Map<String, List<MeasuredRun>> results) {
        this.name = name;
    ...
    public String toString() {
        return "MeasuredRun{" + "name=" + name + ", time='" + (totalTime / iterations / 1000.0) + "'     micro seconds" + '}';
    }
}

...
package org.boon.examples.model.test.movies.likeable;
...
public interface LikingService {
    BatchResults updatePreferences(LikesBulkUpdate request);

    void score(LikeabilityUpdate scoreUpdate);

    RecordReadResponse<Watcher> loadUser(String username, long version);
}

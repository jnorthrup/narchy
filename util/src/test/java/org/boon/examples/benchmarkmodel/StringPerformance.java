...
package org.boon.examples.benchmarkmodel;
...
public class StringPerformance implements Serializable, HasDescription {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StringPerformance)) return false;

        StringPerformance that = (StringPerformance) o;

        if (!Arrays.equals(str, that.str)) return false;
    ...
    @Override
    public int hashCode() {
        return str != null ? Arrays.hashCode(str) : 0;
    }
}

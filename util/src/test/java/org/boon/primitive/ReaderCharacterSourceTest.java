...
public class ReaderCharacterSourceTest {
    ...
    public void setup() {
        ...
        source = new ReaderCharacterSource(new InputStreamReader(inputStream));
    }
    ...
    private void initSourceWithString(String testString, int size) {
        ByteArrayInputStream inputStream = new InMemoryInputStream(testString.getBytes(StandardCharsets.UTF_8));
        source = new ReaderCharacterSource(new InputStreamReader(inputStream), size);
    }
    ...
    @Test
    public void consumeIfMatchNotMatchingTest() {
    ...
    @Test
    public void findStringWithFindNextChar() {
        String testString = "abc \"train\" abc";
        initSourceWithString(testString);
        boolean found = false;
        loop: while (source.hasChar()) {
    ...
    @Test
    public void testEscapeOnBorder() {
    ...
    @Test
    public void findStringWithFindNextCharWithEscape() {
    ...
    @Test
    public void findStringWithFindNextCharWithEscape2() {
    ...
    @Test
    public void findStringWithFindNextCharWithEscapeOfQuote() {

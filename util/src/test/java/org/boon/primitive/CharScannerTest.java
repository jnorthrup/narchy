...
public class CharScannerTest {
    ...
    public void parseDoubleNegative() {
        ...
        double num = (Double) CharScanner.parseJsonNumber(str.toCharArray(), 0, str.length());
    ...
    public void manyDoubles() {
        List<String> doubles = Lists.list("" + 1.01d, "" + 123456789.234D, "" + 55D, "" + Integer.MAX_VALUE + "." + Integer.MAX_VALUE, "66666666.666", "-6666666666.6666", "1E10");
    ...
    private void testDouble(String str) {
        puts(str);
        double num = (Double) CharScanner.parseJsonNumber(str.toCharArray(), 0, str.length()).doubleValue();
        double numTest = Double.parseDouble(str);
    ...
    public void autoSplitThisEndsInSpace() {
        char[] letters = chars("This is a string ");
        char[][] splitted = CharScanner.split(letters, ' ');
        assertEquals(4, splitted.length);
        assertArrayEquals(chars("This"), splitted[0]);
        assertArrayEquals(chars("is"), splitted[1]);
        assertArrayEquals(chars("a"), splitted[2]);
        assertArrayEquals(chars("string"), splitted[3]);
        assertArrayEquals(new char[][] { chars("This"), chars("is"), chars("a"), chars("string") }, splitted);
    }
    ...
    public void autoSplitThisStartSpace() {
        ...
        assertEquals(0, splitted[0].length);
        assertArrayEquals(chars("This"), splitted[1]);
        assertArrayEquals(chars("is"), splitted[2]);
        assertArrayEquals(chars("a"), splitted[3]);
        assertArrayEquals(chars("string"), splitted[4]);
        assertArrayEquals(new char[][] { chars(""), chars("This"), chars("is"), chars("a"), chars("string") }, splitted);
    }
    ...
    public void autoSplitThis3DoubleSpaceAfterA() {
        ...
        assertArrayEquals(chars("is"), splitted[1]);
        assertArrayEquals(chars("a"), splitted[2]);
        assertEquals(0, splitted[3].length);
        assertArrayEquals(chars("string"), splitted[4]);
        assertArrayEquals(new char[][] { chars("This"), chars("is"), chars("a"), chars(""), chars("string") }, splitted);
    }

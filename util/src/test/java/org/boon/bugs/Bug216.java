...
public class Bug216 {
    ...
    public static void main(String[] args) {
        ...
        Repo<String, Map<String, String>> dbRepo = (Repo<String, Map<String, String>>) (Object) Repos.builder().primaryKey("name").lookupIndex("colour").lookupIndex("job").lookupIndex("sport").build(String.class, Map.class);

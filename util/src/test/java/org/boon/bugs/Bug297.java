...
public class Bug297 {
    ...
    public static class MyObject {
        ...
        public boolean equals(Object o) {
            ...
            if (attrs != null ? !attrs.equals(myObject.attrs) : myObject.attrs != null)
                return false;
            if (title != null ? !title.equals(myObject.title) : myObject.title != null)
                return false;
            return true;
        }
        ...
        public String toString() {
            return "MyObject{" + "title='" + title + '\'' + ", attrs=" + attrs + '}';
        }

...
public class Bug175 {
    ...
    public void test() {
        ...
        plan.setCode("CODE");
        plan.setName("BOON");
        CompensationPlan.CompensationLevel compensationLevel = new CompensationPlan.CompensationLevel();
        ...
        CompensationPlan.CompensationLevel compensationLevel2 = new CompensationPlan.CompensationLevel();

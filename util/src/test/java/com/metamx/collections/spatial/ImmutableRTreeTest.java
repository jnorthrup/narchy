...
class ImmutableRTreeTest {
    ...
    void testToAndFromByteBuffer() {
        ...
        ImmutableRTree firstTree = ImmutableRTree.toImmutable(tree);
    ...
    void testSearchNoSplit() {
        ...
        assertEquals(tree.root().children.size(), 10);

        ImmutableRTree searchTree = ImmutableRTree.toImmutable(tree);

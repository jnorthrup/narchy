 ...
 * <p>
 * All lists except this one contain a head, which may be any term, and a tail,
 * which is another list. This recursive defintion terminates with this
 * singleton, the empty list.
 * 
...
public class EmptyList extends Fact {
	 ...
	 * When the empty list represents itself as part of another list, it just
	 * returns "".
	 * 

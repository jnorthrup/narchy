...
public class CompositeNode extends ComponentNode {
	...
	/*
	 * Return a textual description of this node. We take care to print a node
	 * only once, since a composite may contain cycles. We may or may not want
	 * to print the object this composite contains -- the identation indicates
	 * the presence of the composite and can obviate the need for printing the
	 * composite's value. ShowDangle gives an example of not needing to see the
	 * composite's value.
	 */
	protected String toString(int depth, boolean label, Vector visited) {

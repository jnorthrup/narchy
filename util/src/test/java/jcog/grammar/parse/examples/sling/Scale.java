...
public class Scale extends SlingFunction {
	 ...
	 * coordinates.
	 */
	public Scale(SlingFunction aFrom, SlingFunction a, SlingFunction aTo, SlingFunction bFrom, SlingFunction bTo) {

		this.source = new SlingFunction[] { aFrom, a, aTo, bFrom, bTo };
	}

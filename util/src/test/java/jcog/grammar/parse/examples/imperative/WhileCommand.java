...
/**
 * This command mimics a normal "while" loop, executing a command in a loop, so
 * long as some condition holds true.
 * 
...
public class WhileCommand extends Command {
	 ...
	 * 
	 * @param condition
	 *            the condition to check each time before executing the body
	 * 
	 * @param command

...
public class Rule implements Axiom {
	 ...
	 * 
	 * @param Structure
	 *            [] the structures that make up this rule.
	 * 
	 */
	 ...
	 * 
	 * @param Structure
	 *            the structure that makes up this rule.
	 * 
	 */
	...
	public boolean equals(Object o) {
		...
		if (o instanceof Rule) {
			...
			if (structures.length == r.structures.length)
				result = IntStream.range(0, structures.length).allMatch(i -> structures[i].equals(r.structures[i]));
		}
		return result;
	}

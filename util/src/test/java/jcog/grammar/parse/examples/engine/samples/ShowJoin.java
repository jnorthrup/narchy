...
public class ShowJoin {
	...
	private static Program coffee() {
		...
		new Fact("coffee", new Object[] { "Simple Best", "regular", "columbia", new Double(5.95) }),

		new Fact("coffee", new Object[] { "Revit", "italian", "guatemala", new Double(7.95) }),

		new Fact("coffee", new Object[] { "Brimful", "regular", "kenya", new Double(6.95) }),

		new Fact("coffee", new Object[] { "Smackin", "french", "columbia", new Double(7.95) }) };
	...
	private static Program customer() {
		...
		new Fact("customer", new Object[] { "Jane Jerrod", new Integer(2077) }),

		new Fact("customer", new Object[] { "Jasmine Jones", new Integer(2093) }) };
	...
	private static Program order() {
		...
		new Fact("order", new Object[] { new Integer(2077), "Launch Mi", new Integer(3) }),

		new Fact("order", new Object[] { new Integer(2077), "Smackin", new Integer(3) }),

		new Fact("order", new Object[] { new Integer(2093), "Brimful", new Integer(2) })

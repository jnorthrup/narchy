...
/**
 * An object that implements the AxiomEnumeration interface generates a series
 * of axioms, one at a time.
 * 
...
public interface AxiomEnumeration {
	 ...
	 * 
	 * @return <code>true</code> if this enumeration contains more axioms, and

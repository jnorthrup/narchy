 ...
 * </blockquote>
 * 
 * This class retains four parameters which the constructors receive or
 * establish. These parameters are a setup command, a condition, an end command,
 * and a body command.
 * <p>
 * The <code>execute</code> method executes a "for" loop, essentially executing:
 * <blockquote>
 * 
 * <pre>
 * 
...
public class ForCommand implements Command {
	 ...
	 * 
	 * @param Variable
	 *            the variable to iterate
	 * 
	 * @param from
	 *            the initial value for the variable
	 * 
	 * @param to
	 *            a value not to exceed in the loop
	 * 
	 * @param step
    ...
    private ForCommand(Variable v, double from, double to, double step, Command bodyCommand) {
		...
		ArithmeticOperator ao = new ArithmeticOperator('+', v, new NumberFact(step));
	 ...
	 *            the command to repeatedly execute
	 */
	public ForCommand(Variable v, int from, int to, Command bodyCommand) {
	 ...
	 * 
	 * @param setupCommand
	 *            the command to execute before the "for" loop begins
	 * 
	 * @param condition
	 *            the condition to check before executing the body
	 * 
	 * @param endCommand
	 *            the condition to check after executing the body
	 * 
	 * @param bodyCommand
	 *            the command to repeatedly execute
	 */
	public ForCommand(Command setupCommand, BooleanTerm condition, Command endCommand, Command bodyCommand) {
	 ...
	 */
	public void execute() {
		for (setupCommand.execute(); ((Boolean) condition.eval()).booleanValue(); endCommand.execute()) {

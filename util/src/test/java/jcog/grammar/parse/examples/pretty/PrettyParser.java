...
class PrettyParser {
    ...
    private Set<Assembly> completeMatches(Assembly inAssembly) {
        ...
        Set<Assembly> outComplete = new HashSet<>();
	...
	public Vector parseTrees(Assembly inAssembly) {
		Vector outAssemblies = new Vector(completeMatches(inAssembly));
	...
	* </code> object will show labels
	 * for composite nodes.
	 * 
	 * @param boolean the boolean that determines if this
	 *        <code>PrettyParser</code> object will show labels for composite
	 *        nodes.
	 */
	...
	/*
	 * Return a string representation of a parse tree. The tree is a component

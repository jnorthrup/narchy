...
/**
 * This class holds an <code>sjm.engine.Evaluation</code> object, and executes
 * it upon receiving an <code>execute
 * </code> command.
 * 
...
public class AssignmentCommand implements Command {
	...
	public void execute() {
		...
		/*
		 * Note: we can only unbind the variable after evaluating the first
		 * term. Not doing this would create a defect with i := i + 1
		 */

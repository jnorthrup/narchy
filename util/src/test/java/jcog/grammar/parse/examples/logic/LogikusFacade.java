...
/**
 * This class provides utility methods that simplify the use of the Logikus
 * parser.
 * 
	...
	private static void checkForUppercase(TokenString ts, String type) {
		...
		if (ts.length() > 0) {
			...
			if (s.length() > 0 && Character.isUpperCase(s.charAt(0))) {
				...
				throw new LogikusException("> Uppercase " + s + " indicates a variable and cannot begin a " + type + ".\n");
			}
		}
	}

...
public class Query extends DynamicRule {
	 ...
	 * 
	 * @param AxiomSource
	 *            the source to prove against
	 * 
	 * @param Structures
	 *            the structures to prove
	 */
	 ...
	 * 
	 * @param Rule
	 *            the rule that contains structures to prove
	 */
	...
	/*
	 * This constructor ensures that the structures in the query are all
	 * "provable", meaning that they are capable of proving themselves.
	 * Structures cannot achieve this, but they can produce consulting versions

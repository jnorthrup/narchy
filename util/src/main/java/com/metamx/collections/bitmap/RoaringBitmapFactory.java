...
public class RoaringBitmapFactory implements BitmapFactory {
    ...
    private static Iterable<ImmutableRoaringBitmap> unwrap(
        ...
        return () -> {
            ...
            return new ImmutableRoaringBitmapIterator(i);
        };
    }
    ...
    private static class ImmutableRoaringBitmapIterator implements Iterator<ImmutableRoaringBitmap> {
        private final Iterator<ImmutableBitmap> i;

        public ImmutableRoaringBitmapIterator(Iterator<ImmutableBitmap> i) {
            this.i = i;
        }

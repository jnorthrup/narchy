...
public abstract class IntVar {
     ...
     * @see PropagationQueue#add enqueue
     ...
     * {@link PropagationQueue#add enqueue} method each time this
     ...
     * <p>
     * The propagator will be scheduled for propagation using the
     * {@link PropagationQueue#add enqueue} method each time the value of
     ...
     * <p>
     * The propagator will be scheduled for propagation using the
     * {@link PropagationQueue#add enqueue} method each time a value is

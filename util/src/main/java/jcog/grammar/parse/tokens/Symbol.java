...
public class Symbol extends Terminal {
	 ...
	 * 
	 * @param char the character to match. The char must be one that the
	 ...
	 * 
	 * @param String
	 *            the characters to match. The characters must be a sequence
	 *            that the tokenizer will return as a symbol token, such as
	 *            <code><=</code>.
	 * 
	 * @return a Symbol that will match the specified sequence of characters
	 */
	public Symbol(String s) {
		symbol = new Token(Token.TT_SYMBOL, s, BigDecimal.ZERO);
	}

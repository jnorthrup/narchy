 ...
 * <code>SymbolRootNode</code> object has no symbol of its own, but has children
 * that represent all possible symbols.
 * 
...
public class SymbolRootNode extends SymbolNode {
	...
	/*
	 * A root node maintains its children in an array instead of a Vector, to be
	 * faster.
	 */
	@Override
	 ...
	 * 
	 * @param int the first character of this symbol, already read from the
	 *        reader
	 * 
	 * @return a symbol string from a reader
	 */

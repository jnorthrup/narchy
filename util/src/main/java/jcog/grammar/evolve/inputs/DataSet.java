...
public class DataSet implements Serializable {
    ...
    public static DataSet json(String json) {
        try {
            return Util.jsonMapper.readerFor(DataSet.class).readValue(json);
        } catch (IOException e) {
    ...
    public final List<Example> examples = new FasterList<>();
    ...
    public static class Example {
        ...
        public Example(Example example) {
            ...
            if(example.matchedStrings!=null){
                this.matchedStrings = new FasterList<>(example.matchedStrings);
            }
            if(example.unmatchedStrings!=null){
                this.unmatchedStrings = new FasterList<>(example.unmatchedStrings);
        }
        }

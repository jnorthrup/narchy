...
public final class Tries{
    ...
    public static <T> Trie<String, T> forStrings() {
        return new Trie<>(STRING_TRIE_SEQUENCER_CHAR_SEQUENCE);
    }
    ...
    public static <T> Trie<String, T> forStrings(T defaultValue) {
        return new Trie<>(STRING_TRIE_SEQUENCER_CHAR_SEQUENCE, defaultValue);
    }
    ...
    public static <T> Trie<byte[], T> forBytes() {
        return new Trie<>(TRIE_SEQUENCER_BYTE_ARRAY);
    }
    ...
    public static <T> Trie<byte[], T> forBytes(T defaultValue) {
        return new Trie<>(TRIE_SEQUENCER_BYTE_ARRAY, defaultValue);
    }

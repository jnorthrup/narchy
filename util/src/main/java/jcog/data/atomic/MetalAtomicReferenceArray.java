...
/*
 * copied from JDK8 - potentially less overhead than the access guard stuff the official AtomicReferenceArray stupidly does
 *
 ...
 */
public class MetalAtomicReferenceArray<E>  {

	public static final MetalAtomicReferenceArray EMPTY_ARRAY = new MetalAtomicReferenceArray(0);
	 ...
	 */
	public MetalAtomicReferenceArray(int length) {
...
//	 */
//	public MetalAtomicReferenceArray(E[] array) {
...
//	}
	...
	/** use with caution */
	public final E getFast(int i) {
		return getRaw(byteOffset(i));
	}


	@SuppressWarnings("unchecked") private E getRaw(long offset) {

 ...
 * @author Peter Levart
 *
 * adapted from JDK14 http://hg.openjdk.java.net/jdk/jdk/raw-file/94f8a0b34117/src/java.base/share/classes/java/lang/WeakPairMap.java
 */
final class WeakPairMap<K1, K2, V> {
    ...
    WeakPairMap(Map<Pair<K1, K2>, V> map) {
        this.map = map;
    }

...
//            final String url ) {
//
//        return Exceptions.tryIt( Response.class, (Exceptions.TrialWithReturn<Response>) () -> {
//            URLConnection connection;
//
//            final Map<String, String> accept = Maps.map(
//                    "Accept", "text/html,application/xhtml+xml,application/xml,application/json,text/plain;"
...
//
//        return Exceptions.tryIt( byte[].class, () -> {
//            URLConnection connection;
...
//
//
//            buf.addUrlEncoded(stringObjectEntry.getKey());
//            buf.addByte( '=' );
//
...
//            connection.addRequestProperty ( URLEncoder.encode (stringEntry.getKey(), charset), URLEncoder.encode ( value.toString(), charset) );
//        }
//        return connection;
//    }
//

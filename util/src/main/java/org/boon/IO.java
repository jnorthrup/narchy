...
public class IO {
    ...
    private static final ConcurrentHashMap <String, FileSystem> pathToZipFileSystems = new ConcurrentHashMap<>();
    ...
    public static FileSystem zipFileSystem( URI fileJarURI ) {
        ...
        final Map<String, Object> env = Maps.map( "create", "true");
    ...
    public static final ConvertToPathFunction convertToPathFunction = new ConvertToPathFunction();
    ...
    public interface EachLine {
        boolean line(String line, int index);
    }
    ...
    public static List<String> readLines( final String location ) {
        ...
        return ( List<String> ) Exceptions.tryIt( Typ.list, () -> {
    ...
    public static String readPath( final Path path ) {
        ...
        return Exceptions.tryIt( String.class, () -> read(Files.newBufferedReader(path, DEFAULT_CHARSET)));
    ...
    public static List<String> list( final String path ) {
        return list(URI.create( path ));
    }

    public static List<String> list( final URI uri ) {
        if ( uri.getScheme() == null ) {
            final Path pathFromFileSystem = Paths.get(uri);
            return list( pathFromFileSystem );
        } else if ( uri.getScheme().equals( CLASSPATH_SCHEMA ) ) {

            return listFromDefaultClassLoader( StringScanner.split( uri.toString(), ':' )[ 1 ] );
    ...
    public static List<String> listByExt( final String path, String ext ) {
        return listByExt(Paths.get(path), ext);
    }

    public static List<String> listByExt( final Path path, String ext ) {

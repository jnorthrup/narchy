...
public class ObjectFilter {
    ...
    public static Criterion eq( final Object name, final Object value ) {
        return new Criterion<>(name.toString(), Operator.EQUAL, value) {
            @Override
    ...
    public static Criterion notEq( final Object name, final Object value ) {
        return new Criterion<>(name.toString(), Operator.NOT_EQUAL, value) {
            @Override
            public boolean resolve(Object owner) {
    ...
    public static Criterion notIn( final Object name, final Object... values ) {
        return new Criterion<>(name.toString(), Operator.NOT_IN, values) {
    ...
    public static Criterion in( final Object name, final Object... values ) {
        return new Criterion<>(name.toString(), Operator.IN, values) {
    ...
    public static Criterion lt( final Object name, final Object value ) {
        return new Criterion<>(name.toString(), Operator.LESS_THAN, value) {
            @Override
            public boolean resolve(Object owner) {
    ...
    public static Criterion lte( final Object name, final Object value ) {
        return new Criterion<>(name.toString(), Operator.LESS_THAN_EQUAL, value) {
            @Override
            public boolean resolve(Object owner) {
                return ((Comparable) value()).compareTo(fieldValue()) >= 0;
            }
    ...
    public static Criterion gt( final Object name, final Object value ) {
        return new Criterion<>(name.toString(), Operator.GREATER_THAN, value) {
            @Override
            public boolean resolve(Object owner) {
                return ((Comparable) value()).compareTo(fieldValue()) < 0;
            }
    ...
    public static Criterion gte( final Object name, final Object value ) {
        return new Criterion<>(name.toString(), Operator.GREATER_THAN_EQUAL, value) {
            @Override
            public boolean resolve(Object owner) {
                return ((Comparable) value()).compareTo(fieldValue()) <= 0;
            }
    ...
    public static Criterion between( final Object name, final Object value, final Object value2 ) {
        return new Criterion<>(name.toString(), Operator.BETWEEN, value, value2) {
            @Override
            public boolean resolve(Object owner) {
    ...
    public static Criterion startsWith( final Object name, final Object value ) {
        return new Criterion<>(name.toString(), Operator.STARTS_WITH, value) {
    ...
    public static Criterion endsWith( final Object name, final Object value ) {
        return new Criterion<>(name.toString(), Operator.ENDS_WITH, value) {
    ...
    private static Criterion doContains( final Object name, final Object value, final boolean not ) {
        return new Criterion<>(name.toString(), not ? Operator.NOT_CONTAINS : Operator.CONTAINS, value) {
        ...
        switch (operator) {
            ...
            case IN:
                ...
                switch (type){
                    ...
                    default:
                        return in(name, Conversions.toArray(classType, (Collection<Object>) values));
                }
            case NOT_IN:
                ...
                switch (type){
                    ...
                    default:
                        return notIn(name, Conversions.toArray(classType, (Collection<Object>) values));
                }

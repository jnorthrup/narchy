...
public class ValidationContext {
    ...
    private final ArrayDeque<String> bindingPath = new ArrayDeque<>();
     ...
     */
    private static final ThreadLocal<ValidationContext> holder = new ThreadLocal<>();
     ...
     */
    private final String i18nMarker = "{";
     ...
     * @param context xx
     */
    protected static void register(ValidationContext context) {
        holder.set( context );
    }
     ...
     * @return xx
     */
    public static Object getProposedPropertyValue(String propertyName) {
        return null;
    }

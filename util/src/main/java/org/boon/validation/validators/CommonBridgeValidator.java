...
public class CommonBridgeValidator extends BaseValidator {
    ...
    public ValidatorMessageHolder validate( Object object, String fieldLabel ) {
        ...
        try {
            ...
            valid = ( Boolean ) validateMethod.invoke( validator, new Object[]{object} );
    ...
    private void initValidateMethodIfNeeded() throws Exception {
        if ( validateMethod == null ) {
            validateMethod = validatorClass.getMethod( methodName, String.class);
        }
    }
     ...
     */
    private void initValidatorIfNeeded() throws Exception, NoSuchMethodException, InvocationTargetException {
        if ( validator == null ) {

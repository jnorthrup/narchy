...
public class RecursiveDescentPropertyValidator {
     ...
     */
    protected static CompositeValidator createValidator(
    ...
    private static List<PropertyDescriptor> getFieldsToValidate(Object object) {
    ...
    protected static boolean shouldFieldBeValidated() {
        return true;
    }
    ...
    public List<MessageHolder> validateObject( final Object object ) {
        ...
        List<MessageHolder> list = Collections.emptyList();
        try {
     ...
     */
    private static List<FieldValidator>
     ...
     */
    private static FieldValidator lookupValidatorInRegistry(
     ...
     */
    private static void applyValidationMetaDataPropertiesToValidator(
     ...
     */
    private static void ifPropertyBlankRemove(Map<String, Object> properties, String property) {
        ...
        if ( object == null ) {
            ...
            if (string.trim() != null && string.trim().isEmpty()) {
                properties.remove( property );
            }
        }
    }

...
public class BoonTemplate implements Template {
    ...
    private final CharBuf _buf = CharBuf.create(16);
    private BoonTemplate parentTemplate;
    private final TemplateParser parser;
    private String template;
    private final ExpressionContext _context;
    private final BoonCommandArgumentParser commandArgumentParser = new BoonCommandArgumentParser();
    ...
    private void handleInclude(Map<String, Object> params, List<Token> commandTokens) {
        ...
        switch (type) {
            case "":
                try {
                    includeParser = parser.getClass().getConstructor().newInstance();
                } catch (Exception e) {

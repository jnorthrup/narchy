        ...
        //try {
            ...
            switch ( typeEnum ) {
                ...
                case CHAR:
                    ...
                    if ( cvalue != 0 ) {
                        serializeFieldName ( fieldName, builder );
                        builder.addQuoted(String.valueOf(cvalue));
                        return true;
                    }
                    return false;
...
//        }
    ...
    public static void serializeCurrency(Currency currency, CharBuf builder) {
        builder.addChar ( '"' );
    ...
    public Map<String, FieldAccess> getFields( Class<?> aClass ) {
        Map<String, FieldAccess> map = fieldMap.computeIfAbsent(aClass, k -> doGetFields(aClass));
        return map;

   }

    private static Map<String, FieldAccess> doGetFields(Class<?> aClass) {

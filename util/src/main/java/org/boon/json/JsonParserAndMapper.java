...
public interface JsonParserAndMapper extends JsonParser {
    ...
    char     [] parseCharArray(String jsonString);
    byte     [] parseByteArray(String jsonString);
    short    [] parseShortArray(String jsonString);
    int      [] parseIntArray(String jsonString);
    float    [] parseFloatArray(String jsonString);
    double   [] parseDoubleArray(String jsonString);
    long     [] parseLongArray(String jsonString);

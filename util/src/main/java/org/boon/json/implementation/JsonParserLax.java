...
public class JsonParserLax extends JsonFastParser {
    ...
    private static final ValueContainer EMPTY_LIST = new ValueContainer ( Collections.emptyList() );
        ...
        for (; __index < this.charArray.length; __index++ ) {
            ...
            switch ( __currentChar ) {
                ...
                case ':':
                    ...
                    if (events!=null) if(!events.objectFieldName( __index, map, (CharSequence) key))stop();
                    __index++; //skip :


                    item = decodeValueInternal();
                    if (events!=null) if(!events.objectField( __index,  map, (CharSequence) key, item ))stop();
                    skipWhiteSpaceIfNeeded ();
                ...
                case '"':
                    ...
                    if (events!=null) events.objectFieldName( __index, map, (CharSequence) key);

...
public class SearchableCollectionDefault<KEY, ITEM> implements SearchableCollection<KEY, ITEM>, SearchableCollectionComposer {
    ...
    private final Logger log = Logger.getLogger(SearchableCollectionDefault.class.getName() );

    protected final Map<String, LookupIndex> lookupIndexMap = new LinkedHashMap<>();
    protected final Map<String, SearchIndex> searchIndexMap = new LinkedHashMap<>();
    protected final Set<LookupIndex> indexes = new LinkedHashSet<>();

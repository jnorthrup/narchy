...
public class Sets {
    ...
    public static <V> Set<V> copy( Set<V> collection ) {
        if ( collection instanceof NavigableSet ) {
            ...
            return copy((HashSet<V>) collection);
        }
    }
    ...
    public static <V> Set<V> deepCopy( Set<V> set ) {
        if ( set instanceof LinkedHashSet ) {
            return deepCopyToSet(set, new LinkedHashSet<>());
        } else if ( set instanceof CopyOnWriteArraySet ) {
            return deepCopyToSet(set, new CopyOnWriteArraySet<>());
        } else if ( set instanceof HashSet ) {
            return deepCopyToSet(set, new HashSet<>());
        } else {

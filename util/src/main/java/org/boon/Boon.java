...
public class Boon {
     ...
     */
    private final static BoonLogger logger;
    ...
    public static String jstl(String template, Object context) {
        return BoonTemplate.jstl().replace(template, context);
    }
     ...
     * @return logger.
     */
    public static BoonLogger logger(final Class<?> clazz) {
        return new BoonLogger(BoonLogging.logger(clazz));
    }
     ...
     * @return logger.
     */
    public static BoonLogger logger(String name) {
        return new BoonLogger(BoonLogging.logger(name));
    }
     ...
     * @return logger.
     */
    public static BoonLogger configurableLogger(String name) {
        return new BoonLogger(BoonLogging.configurableLogger(name));
    }
     ...
     * @return logger.
     */
    public static BoonLogger configurableLogger(final Class<?> clazz) {
        return new BoonLogger(BoonLogging.configurableLogger(clazz.getName()));
    }
     ...
     */
    private static BoonLogger _log() {
        if (debugOn()) {
            return new BoonLogger(new TerminalLogger().level(LogLevel.DEBUG));
        } else {

...
public class NamespaceEventHandler implements JsonParserEvents {
    ...
    public List<String> include() {
        return include == null ? java.util.Collections.emptyList() : include;
    }
    ...
    private static List<String> toList(Object include) {
    ...
    private static Map<String, Object> toMap(Object field) {

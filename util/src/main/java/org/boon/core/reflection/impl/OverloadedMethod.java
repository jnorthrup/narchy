...
public class OverloadedMethod implements MethodAccess {
    ...
    final List<MethodAccess> methodAccessList = new ArrayList<>();

    final List<List<MethodAccess>> methodAccessListByArgNumber = new ArrayList<>();


    final List<List<MethodAccess>> methodAccessListByArgNumberWithVarArg = new ArrayList<>();
    ...
    private static int handleLongArg(int score, Object arg, TypeType instanceType) {
        switch (instanceType) {
    ...
    private static int handleByteArg(int score, Object arg, TypeType instanceType) {
    ...
    private static int handleShortArg(int score, Object arg, TypeType instanceType) {
    ...
    private static int handleIntArg(int score, Object arg, TypeType instanceType) {
        switch (instanceType) {
    ...
    private static int handleFloatArg(int score, Object arg, TypeType instanceType) {
        switch (instanceType) {
    ...
    private static int handleDoubleArg(int score, Object arg, TypeType instanceType) {
        switch (instanceType) {

            ...
            case ARRAY_OBJECT:
                if (acceptSingleValueAsArray && ValueContainer.NULL != value && !(objValue instanceof Collection)) {
                    if (objValue instanceof ValueMapImpl) {
                        objValue = Collections.singletonList(new ValueContainer(objValue, MAP, false));
                    } else {
                        objValue = Collections.singletonList(objValue);
                    }
                }

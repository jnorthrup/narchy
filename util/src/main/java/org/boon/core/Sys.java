...
public class Sys {
    ...
    public static final ConcurrentHashMap <Object, Object> systemProperties = new ConcurrentHashMap<>(System.getProperties());

    public static final ConcurrentHashMap <String, String> env = new ConcurrentHashMap<>(System.getenv());
    ...
    final static AtomicReference<TimeKeeper> timer = new AtomicReference<>(new TimeKeeperBasic());
    ...
    public static BigDecimal sysPropBigDecimal(String key) {
        return sysPropBigDecima(key, null);
    }
    ...
    public static BigInteger sysPropBigInteger(String key) {
        return sysPropBigInteger(key, null);
    }

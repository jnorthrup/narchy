...
public class Typ {
    ...
    private static final Set<Class> basicTypeOrCollection = Sets.safeSet((Class)int.class, float.class, short.class,
    ...
    private static final Set<Class> primitiveNumber = Sets.safeSet((Class)int.class, float.class, short.class,

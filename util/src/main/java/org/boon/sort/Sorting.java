...
public class Sorting {
     ...
     * Gets the logger.
     */
    private static final BoonLogger log = Boon.configurableLogger(Sorting.class.getName());
    ...
    public static void sort( List list, String sortBy, boolean ascending, boolean nullsFirst ) {
        ...
        if (sortBy.equals("this")) {
            ...
            list.sort(thisUniversalComparator(ascending, nullsFirst));
            return;
        }
        ...
        if (fields!=null) {
            ...
            if ( field != null ) {
                ...
                list.sort(Sorting.universalComparator(field, ascending, nullsFirst));
    ...
    public static Comparator universalComparator( final FieldAccess field, final boolean ascending,
        ...
        return (o1, o2) -> {
            ...
            return compare(value1, value2, nullsFirst);
        };
    }

...
//                        "return ws;")
//        public native static WebSocket newSocket(String url);
//
//        @JSBody(params = {"socket", "each"},
//                script = "socket.onmessage = function(m) { each(m.data); };")
//        public native static void setOnMessage(WebSocket socket, JSConsumer each);
//
//        @JSBody(params = {"socket", "each"},
//                script = "socket.onopen = each; ")
//        public native static void setOnOpen(WebSocket socket, JSRunnable each);
//
//        @JSBody(params = {"socket", "each"},
//                script = "socket.onclose = each; ")
//        public native static void setOnClose(WebSocket socket, JSRunnable each);
//    }
//
//

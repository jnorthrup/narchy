...
public interface TwoPlayerGame {
     ...
     *
     * @param player1 represents the game-logic of a player participating in the game
     * @param player2 represents the game-logic of the other player participating in the game

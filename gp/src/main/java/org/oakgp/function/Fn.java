...
public interface Fn {
     ...
     * @param assignments represents values assigned to variables belonging to {@code arguments}
    ...
    default String name() {
        ...
        if (lowerCaseNameMinusPackage.startsWith("is") && sig().returnType() == NodeType.booleanType())  {

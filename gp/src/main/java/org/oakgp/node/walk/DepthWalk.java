...
public final class DepthWalk {
    ...
    public interface DepthWalkStrategy {
        /**
         * @param node  a node that has been encountered while walking a tree structure
         * @param depth the depth (distance from the root) of the specified {@code node} within the tree structure being walked

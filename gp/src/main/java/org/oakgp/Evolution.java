...
public final class Evolution {
    ...
    private GPRandom _random = RANDOM;
     ...
     */
    public RandomSetter returns(final Type returnType) {
    ...
    public interface FunctionSetSetter {
         ...
         */
        GenerationRankerSetter functions(Function... functions);

        /**
         * Sets the functions that are available for use in the construction of programs generated by the run.
         */
        GenerationRankerSetter functions(List<Function> functions);
    }
    ...
    public interface TerminatorSetter extends MaxGenerationsTerminatorSetter {
         ...
         */
        TerminatorSetterOrProcessRunner setTerminator(Predicate<Candidates> terminator);

        /**
         * Set the target fitness that when found should cause the run to stop.
         */
        MaxGenerationsTerminatorSetterOrProcessRunner goalTarget(double targetFitness);
    }
     ...
     */
    public interface ProcessRunner extends Supplier<Candidates> {
        /**
    ...
    public final class RandomSetter extends PrimitiveSetSetter {
         ...
         */
        public PrimitiveSetSetter setRandom(final GPRandom random) {
    ...
    public final class VariablesSetter {
         ...
         */
        public VariablesRatioSetter variables(final Type... variableTypes) {
    ...
    public final class VariablesRatioSetter implements FunctionSetSetter {
        ...
        @Override
        public GenerationRankerSetter functions(Function... functions) {
            return setRatioVariables(RATIO_VARIABLES).functions(functions);
        }

        @Override
        public GenerationRankerSetter functions(final List<Function> functions) {
            return setRatioVariables(RATIO_VARIABLES).functions(functions);
        }
    }
    ...
    private final class FunctionSetSetterImpl implements FunctionSetSetter {
        ...
        @Override
        public GenerationRankerSetter functions(final List<Function> functions) {
            return functions(functions.toArray(new Function[0]));
        }
    ...
    public final class GenerationRankerSetter {
        ...
        public InitialPopulationSetter goal(final FitnessFunction fitnessFunction) {
         ...
         */
        public InitialPopulationSetter goal(final FitnessFunction fitnessFunction, boolean parallel) {
    ...
    public final class InitialPopulationSetter {
         ...
         */
        public TreeDepthSetter population(final int generationSize) {
    ...
    private class FirstTerminatorSetter implements TerminatorSetter {
        private final List<Predicate<Candidates>> terminators = new ArrayList<>();

        private FirstTerminatorSetter() {
        }

        @Override
        public TerminatorSetterOrProcessRunner setTerminator(final Predicate<Candidates> terminator) {
            terminators.add(requireNonNull(terminator));
            return new SubsequentTerminatorSetter(terminators);
        }

        @Override
        public MaxGenerationsTerminatorSetterOrProcessRunner goalTarget(double targetFitness) {
            return new SubsequentTerminatorSetter(terminators).goalTarget(targetFitness);
        }
    ...
    private final class SubsequentTerminatorSetter extends MaxGenerationsTerminatorSetterImpl implements TerminatorSetterOrProcessRunner {
        private SubsequentTerminatorSetter(List<Predicate<Candidates>> terminators) {
            super(terminators);
        }
        ...
        @Override
        public MaxGenerationsTerminatorSetterOrProcessRunner goalTarget(double targetFitness) {
            terminators.add(new TargetFitnessTerminator(c -> Math.abs(c.fitness - targetFitness) < .0000001));
    ...
    private class MaxGenerationsTerminatorSetterImpl extends MaxGenerationsWithoutImprovementTerminatorSetterImpl implements
        ...
        private MaxGenerationsTerminatorSetterImpl(List<Predicate<Candidates>> terminators) {
            super(terminators);
        }
    ...
    private class MaxGenerationsWithoutImprovementTerminatorSetterImpl implements MaxGenerationsWithoutImprovementTerminatorSetterOrProcessRunner {
        protected final List<Predicate<Candidates>> terminators;

        private MaxGenerationsWithoutImprovementTerminatorSetterImpl(List<Predicate<Candidates>> terminators) {
        ...
        @Override
        public final Candidates get() {
            return new ProcessRunnerImpl(terminators).get();
        }
    }

    private final class ProcessRunnerImpl implements ProcessRunner {
        private final Predicate<Candidates> terminator;

        @SuppressWarnings("unchecked")
        private ProcessRunnerImpl(List<Predicate<Candidates>> terminators) {
        ...
        private Map<GeneticOperator, Integer> createDefaultGeneticOperators(int populationSize) {
            Map<GeneticOperator, Integer> operators = new HashMap<>(5);
            TreeGenerator treeGenerator = TreeGeneratorImpl.grow(_primitiveSet, _random);

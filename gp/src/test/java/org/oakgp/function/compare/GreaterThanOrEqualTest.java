...
public class GreaterThanOrEqualTest extends AbstractFnTest {
    @Override
    ...
    protected Fn[] getFunctionSet() {
        return new Fn[]{getFunction(), new GreaterThanOrEqual(stringType()), LessThanOrEqual.create(integerType())};
    }
}

...
public class RoundRobinTournamentRankerTest {
    @Test
    public void test() {
        ...
        GenerationRanker tournament = new RoundRobinTournamentRanker(mockGame);
        Ranking output = new Ranking(3);
        tournament.accept(Stream.of(a,b,c), output);

...
public abstract class IIRFilter extends UGen {
     ...
     *
     * @param freq The frequency to evaluate.
     ...
     * delay, group delay.
     *
     * @param bs           The b coefficients (corresponding to the x(n) terms of the
     *                     filter algorithm.
     * @param as           The a coefficients (corresponding to the y(n) terms of the
     *                     filter algorithm.
     * @param freq         The frequency to evaluate.

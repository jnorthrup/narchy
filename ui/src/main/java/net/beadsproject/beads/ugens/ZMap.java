...
public class ZMap extends UGen implements DataBeadReceiver {
     ...
     *
     * @param sourceMin The "minimum" expected value.
     ...
     *
     * @param sourceMax The "maximum" expected value.
     * @return This ZMap instance.
     */
     ...
     *
     * @param targetMin The "minimum" output value.
     * @return This ZMap instance.
     */
     ...
     *
     * @param targetMax The "maximum" output value.
     * @return This ZMap instance.
     */
     ...
     *
     * @param sourceMin The "minimum" incoming value.
     * @param sourceMax The "maximum" incoming value.
     * @param targetMin The "minimum" outgoing value.

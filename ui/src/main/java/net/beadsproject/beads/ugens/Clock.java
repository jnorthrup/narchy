...
public class Clock extends UGen implements IntegerBead {
     ...
     * The listeners.
     */
    private final AuventArray listeners;
     ...
     */
    private final float clickStrength;

    /**
     * Used so that other objects can discover what
     */
    private final double[] subticks;
     ...
     */
    public void on(Auvent newListener) {
     ...
     */
    public void removeMessageListener(Auvent newListener) {

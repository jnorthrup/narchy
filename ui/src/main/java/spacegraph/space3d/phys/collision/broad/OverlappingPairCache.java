...
public abstract class OverlappingPairCache implements OverlappingPairCallback {
	...
	public abstract void processAllOverlappingPairs(OverlapCallback callback, Intersecter intersecter);
	
	public abstract BroadphasePair findPair(Broadphasing proxy0, Broadphasing proxy1);

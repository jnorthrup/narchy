...
public class AxisSweep3 extends AxisSweep3Internal {
	...
	public AxisSweep3(v3 worldAabbMin, v3 worldAabbMax) {
		this(worldAabbMin, worldAabbMax, 16384, null);
	}

	public AxisSweep3(v3 worldAabbMin, v3 worldAabbMax, int maxHandles) {
		this(worldAabbMin, worldAabbMax, maxHandles, null);
	}
	
	private AxisSweep3(v3 worldAabbMin, v3 worldAabbMax, int maxHandles/* = 16384*/, OverlappingPairCache pairCache/* = 0*/) {

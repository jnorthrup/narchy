...
public class RagDoll  {
    ...
    public Body3D[] build(Dynamics3D world, v3 positionOffset, float scale_ragdoll) {
        ...
        MatrixUtil.setEulerZYX(transform.basis, (float) 0, (float) 0, ExtraGlobals.SIMD_HALF_PI);
        tmpTrans.mul(offset, transform);
        ...
        MatrixUtil.setEulerZYX(localA.basis, (float) 0, ExtraGlobals.SIMD_HALF_PI, (float) 0);
        localA.set(0f, 0.15f * scale_ragdoll, 0f);
        MatrixUtil.setEulerZYX(localB.basis, (float) 0, ExtraGlobals.SIMD_HALF_PI, (float) 0);

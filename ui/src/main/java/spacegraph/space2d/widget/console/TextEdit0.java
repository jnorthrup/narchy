...
@Deprecated public class TextEdit0 extends ConsoleGUI {
    ...
    public TextEdit0(String initialText) {
        this(initialText, initialText.contains("\n"));
    }
    public TextEdit0(int cols, int rows) {
        this(new TextEditUI(cols, rows));
    }

    public TextEdit0(String initialText, boolean multiline) {
        this(new TextEditUI(initialText, multiline));
    }

    public TextEdit0(TextEditUI ui) {
        super(ui);
...
//    }
    ...
    public TextEdit0 text(String text) {

...
//    private final float saDecay = DEFAULT_SPECTRUM_ANALYSER_DECAY;
//    private final float saGain = DEFAULT_SPECTRUM_ANALYSER_GAIN;
//    private int mSpectrumAnalyzer_BandCount;
//    private final BandDistribution mSpectrumAnalizer_BandDistribution = DEFAULT_SPECTRUM_ANALYSER_BAND_DISTRIBUTION;
//    private Band[] mSpectrumAnalyser_BandDistributionTable;
//    private final BandGain saBandGain = DEFAULT_SPECTRUM_ANALYSER_BAND_GAIN;
//    private float[] sabgTable;
//    private float saBandWidth;
//    private final boolean saShowFrequencies = true;

...
//        FrameStarter.start("JPC Editor - this edition scrolls and highlights simplest java syntax", scroller);
    ...
    public void addWordMatchRule(TextStyle highlight, String word) {
    ...
    public void addEverythingAfterMatchExceptInBetweenMatchRule(TextStyle highlight, String after_match, String in_between_match) {
        rules.add(new EverythingAfterMatchExceptInBetweenMatchRule(after_match, in_between_match, highlight));
    }

    public void addWordBeforeMatchRule(TextStyle highlight, String match) {
        rules.add(new WordBeforeMatchRule(match, highlight));
    }

    //override possible::
    public static final String wordMatcher = "[A-Za-z0-9_]+";
...
//    }
    ...
    private static class WordMatchRule extends SyntaxRule {
        ...
        public WordMatchRule(String word, TextStyle highlight) {
            this.word = word;
    ...
    private static class BetweenMatchesRule extends SyntaxRule {
        ...
        public BetweenMatchesRule(String start, String end, String escape, TextStyle highlight) {
            this.start = start;
            this.end = end;
            this.escape = escape;
            this.highlight = highlight;
    ...
    private static class EverythingAfterMatchRule extends SyntaxRule {
        ...
        public EverythingAfterMatchRule(String match, TextStyle highlight) {
            this.match = match;
            this.highlight = highlight;
        }
    ...
    private static class EverythingAfterMatchExceptInBetweenMatchRule extends SyntaxRule {
        ...
        public EverythingAfterMatchExceptInBetweenMatchRule(String after_match, String in_between_match, TextStyle highlight) {
    ...
    private static class WordBeforeMatchRule extends SyntaxRule {
        ...
        public WordBeforeMatchRule(String match, TextStyle highlight) {
            this.match = match;
            this.highlight = highlight;
        }

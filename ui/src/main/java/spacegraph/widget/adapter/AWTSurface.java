...
import spacegraph.input.Keyboard;
...
//        Component ui = new JSlider(SwingConstants.VERTICAL);
        ...
        Component ui = new JCTermSwingFrame();
    ...
    public boolean onKey(KeyEvent e, boolean pressed) {
        ...
        if (myFocus != null) {
            ...
            if (pressed && e.isPrintableKey()) {
                ...
                try {
                    processKeyEvent.invoke(m, new java.awt.event.KeyEvent(src,
                            pressed ? java.awt.event.KeyEvent.KEY_PRESSED : java.awt.event.KeyEvent.KEY_PRESSED,
                            System.currentTimeMillis(),

...
public class SmoothValue {
  ...
  private SmoothValue(double initialValue, int numOfDiv, MovingType movingType) {
  ...
  private void setValue(double value, int delayTime, MovingType movingType) {
  ...
  private void setValue(double value, int delayTime, MovingType movingType, int numOfDiv) {
    this.movingType = movingType;
